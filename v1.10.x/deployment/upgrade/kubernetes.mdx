...
import UpgradePrerequisites from '/snippets/v1.10.x/deployment/upgrade/upgrade-prerequisites.mdx'
...
[Kubernetes Deployment](/v1.10.x/deployment/kubernetes) guide.
...
You can learn more about how the migration process works [here](/v1.10.x/deployment/upgrade/how-does-it-work).
...
4. Install the latest version of [OpenMetadata Dependencies Helm Chart](/v1.10.x/deployment/kubernetes)
5. Restore the Database using Metadata Restore CLI as mentioned [here](/v1.10.x/deployment/backup-restore-metadata)
