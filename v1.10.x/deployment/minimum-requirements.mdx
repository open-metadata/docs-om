...
Please refer to the [architecture section](/v1.10.x/developers/architecture) for more details.
...
Learn more about how to deploy and manage the ingestion workflows [here](/v1.10.x/deployment/ingestion).
