...
For example, if you are using the [Glue](/v1.10.x/connectors/database/glue) connector you could specify the
...
You can validate the whole Google service account setup [here](/v1.10.x/deployment/security/google).
...
(e.g., [Athena](/v1.10.x/connectors/database/athena/yaml)).
