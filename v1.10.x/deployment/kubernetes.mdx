...
Network Policies and Ingresses are optional manifests and disabled by default. These can be installed / enabled using the [Helm Values](/v1.10.x/deployment/kubernetes/on-prem).

## Links

<CardGroup cols={2}>
<Card title="Helm Values" href="/v1.10.x/deployment/kubernetes/values" >
    For customizing OpenMetadata Helm Deployments
  </Card>
  <Card title="Deploy in AWS EKS" href="/v1.10.x/deployment/kubernetes/eks" >
    Deploy OpenMetadata in AWS Kubernetes
  </Card>
  <Card title="Deploy in GCP GKE" href="/v1.10.x/deployment/kubernetes/gke" >
    Deploy OpenMetadata in GCP Kubernetes
  </Card>
  <Card title="Deploy in Azure AKS" href="/v1.10.x/deployment/kubernetes/aks" >
    Deploy OpenMetadata in Azure Kubernetes
  </Card>
  <Card title="Deploy in OnPremises Kubernetes" href="/v1.10.x/deployment/kubernetes/on-prem" >
