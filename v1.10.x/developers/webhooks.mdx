...
In 0.13.1 , webhooks have been deprecated. You should instead use [OpenMetadata alerts](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts)
