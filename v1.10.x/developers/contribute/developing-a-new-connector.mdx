...
Developing a new connector makes sense if it could be used by many other users. **If you are dealing with a custom solution used only in your case, it makes more sense to actually create your own Custom Connector by following [this guide](/v1.10.x/connectors/custom-connectors)**
...
Please follow the instructions [here](/v1.10.x/developers/contribute/build-code-and-run-tests)

## Steps

1. [Define the JSON Schema](/v1.10.x/developers/contribute/developing-a-new-connector/define-json-schema)
2. [Develop the Ingestion Code](/v1.10.x/developers/contribute/developing-a-new-connector/develop-ingestion-code)
3. [Apply UI Changes](/v1.10.x/developers/contribute/developing-a-new-connector/apply-ui-changes)
4. [Create the Java ClassConverter](/v1.10.x/developers/contribute/developing-a-new-connector/create-java-class-converter)
5. [Test it](/v1.10.x/developers/contribute/developing-a-new-connector/test-it)
6. [Update the Documentation](/v1.10.x/developers/contribute/developing-a-new-connector/update-documentation)
