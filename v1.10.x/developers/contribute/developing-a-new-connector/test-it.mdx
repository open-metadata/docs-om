...
The easiest way to do is to check how to do it [here](/v1.10.x/developers/contribute/build-code-and-run-tests).
...
<Card title="Update the Documentation" href="/v1.10.x/developers/contribute/developing-a-new-connector/update-documentation" >
