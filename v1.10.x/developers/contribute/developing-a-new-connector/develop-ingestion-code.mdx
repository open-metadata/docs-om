...
<Card title="OpenMetadata 1.6.0 or later" href="/v1.10.x/deployment" >
...
<Card title="Apply the UI Changes" href="/v1.10.x/developers/contribute/developing-a-new-connector/apply-ui-changes" >
