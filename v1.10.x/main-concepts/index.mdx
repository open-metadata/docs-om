...
<CardGroup>
  <Card title="High Level Design" href="/v1.10.x/main-concepts/high-level-design">
...
<CardGroup cols={2}>
  <Card title="OpenMetadata Schemas" href="/v1.10.x/main-concepts/metadata-standard/schemas">
    Review the standard that powers OpenMetadata with JSON Schema.
  </Card>
  <Card title="OpenMetadata APIs" href="/v1.10.x/main-concepts/metadata-standard/apis">
