...
|--------|----------|-------------|
| `POST` | `/v1/dataQuality/testCases` | [Create a test case](/v1.10.x/api-reference/data-quality/test-cases/create) |
| `GET` | `/v1/dataQuality/testCases` | [List test cases](/v1.10.x/api-reference/data-quality/test-cases/list) |
| `GET` | `/v1/dataQuality/testCases/{id}` | [Get by ID](/v1.10.x/api-reference/data-quality/test-cases/retrieve) |
| `GET` | `/v1/dataQuality/testCases/name/{fqn}` | [Get by FQN](/v1.10.x/api-reference/data-quality/test-cases/retrieve) |
| `PATCH` | `/v1/dataQuality/testCases/{id}` | [Update by ID](/v1.10.x/api-reference/data-quality/test-cases/update) |
| `DELETE` | `/v1/dataQuality/testCases/{id}` | [Delete by ID](/v1.10.x/api-reference/data-quality/test-cases/delete) |
| `GET` | `/v1/dataQuality/testCases/{id}/versions` | [List versions](/v1.10.x/api-reference/data-quality/test-cases/versions) |
| `GET` | `/v1/dataQuality/testCases/{id}/testCaseResult` | [Get test results](/v1.10.x/api-reference/data-quality/test-cases/results) |
| `PUT` | `/v1/dataQuality/testCases/{id}/testCaseResult` | [Add test result](/v1.10.x/api-reference/data-quality/test-cases/results) |
