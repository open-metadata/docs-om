...
- [Troubleshooting](/v1.10.x/connectors/pipeline/glue-pipeline/troubleshooting)
...
- **Kafka Service Name** : The Service Name of the Ingested [Kafka](/v1.10.x/connectors/messaging/kafka#4.-name-and-describe-your-service) instance associated with this KafkaConnect instance.
</Step>
<TestConnection />
<ConfigureIngestion />
...
* [MySQL](/v1.10.x/connectors/database/mysql)
* [PostgreSQL](/v1.10.x/connectors/database/postgres)
* [MSSQL](/v1.10.x/connectors/database/mssql)
* [MongoDB](/v1.10.x/connectors/database/mongodb)
* [Amazon S3](/v1.10.x/connectors/storage/s3)
