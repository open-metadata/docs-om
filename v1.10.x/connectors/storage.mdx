...
import ConnectorsList from '/snippets/v1.10.x/connectors/storage/connectors-list.mdx'
...
- Structured data in single and independent files (which can also be ingested with the [S3 Data Lake connector](/v1.10.x/connectors/database/s3-datalake))
