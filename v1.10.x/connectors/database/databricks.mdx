...
- [Troubleshooting](/v1.10.x/connectors/database/databricks/troubleshooting)
...
## Unity Catalog
If you are using Unity Catalog in Databricks, then checkout the [Unity Catalog](/v1.10.x/connectors/database/unity-catalog) connector.
## Metadata Ingestion
