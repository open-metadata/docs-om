...
import Related from '/snippets/v1.10.x/connectors/database/related.mdx'
...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.10.x/connectors/ingestion/workflows/metadata/incremental-extraction/redshift)
- [Query Usage](/v1.10.x/connectors/ingestion/workflows/usage)
- [Data Profiler](/v1.10.x/how-to-guides/data-quality-observability/profiler/profiler-workflow)
- [Data Quality](/v1.10.x/how-to-guides/data-quality-observability/quality)
- [Lineage](/v1.10.x/connectors/ingestion/lineage)
- [dbt Integration](/v1.10.x/connectors/database/dbt)
- [Enable Security](#securing-redshift-connection-with-ssl-in-openmetadata)
- [Troubleshooting](/v1.10.x/connectors/database/redshift/troubleshooting)
...
Executing the profiler workflow or data quality tests, will require the user to have `SELECT` permission on the tables/schemas where the profiler/tests will be executed. More information on the profiler workflow setup can be found [here](/v1.10.x/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v1.10.x/how-to-guides/data-quality-observability/quality).
### Usage & Lineage
For the usage and lineage workflow, the user will need `SELECT` privilege on `STL_QUERY` table. You can find more information on the usage workflow [here](/v1.10.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v1.10.x/connectors/ingestion/workflows/lineage).
## Metadata Ingestion
