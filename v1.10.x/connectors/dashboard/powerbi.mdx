...
- [Lineage](#lineage)
- [Troubleshooting](/v1.10.x/connectors/dashboard/powerbi/troubleshooting)
## Requirements
<Warning>
...
Refer to the section [here](/v1.10.x/connectors/dashboard/powerbi#powerbi-admin-and-nonadmin-apis) to get more information.
- Enabled (Use PowerBI Admin APIs)
- Disabled (Use Non-Admin PowerBI APIs)
</Step>
<TestConnection />
