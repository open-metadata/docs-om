...
<CardGroup cols={3}>
<Card title="Configure dbt workflow from OpenMetadata UI" href="/v1.10.x/connectors/ingestion/workflows/dbt/configure-dbt-workflow-from-ui" >
    Configure the dbt Workflow from the UI.
  </Card>

<Card title="Run dbt Workflow Externally" href="/v1.10.x/connectors/ingestion/workflows/dbt/run-dbt-workflow-externally" >
    Configure the dbt Workflow from the CLI.
  </Card>

<Card title="Auto Ingest dbt Artifacts (dbt-core)" href="/v1.10.x/connectors/ingestion/workflows/dbt/auto-ingest-dbt-core" >
