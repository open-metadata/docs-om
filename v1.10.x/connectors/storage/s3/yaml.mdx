...
## Requirements
<Card title="OpenMetadata 1.0 or later" href="/v1.10.x/deployment" >
...
You can learn more about this [here](/v1.10.x/connectors/storage). Keep reading for an example on the shape of the manifest file.
<Manifest />
## Metadata Ingestion
