...
<CardGroup cols={2}>
<Card title="Profiler Tab" href="/v1.10.x/how-to-guides/data-quality-observability/profiler/tab" >
    Get a complete picture of the Table Profile and Column Profile details.
  </Card>
 <Card title="Profiler Workflow" href="/v1.10.x/how-to-guides/data-quality-observability/profiler/profiler-workflow" >
    Configure and run the Profiler Workflow to extract Profiler data.
  </Card>
 <Card title="Metrics" href="/v1.10.x/how-to-guides/data-quality-observability/profiler/metrics" >
    Learn about the supported profiler metrics.
  </Card>
 <Card title="Auto Pii Tagging" href="/v1.10.x/how-to-guides/data-quality-observability/profiler/auto-pii-tagging" >
    Automatically detect and tag columns containing sensitive PII data during profiling.
  </Card>
 <Card title="Spark Engine" href="/v1.10.x/how-to-guides/data-quality-observability/profiler/spark-engine" >
