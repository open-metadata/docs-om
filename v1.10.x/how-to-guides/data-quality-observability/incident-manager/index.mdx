...
<CardGroup cols={2}>
<Card title="How to work with the Incident Manager" href="/v1.10.x/how-to-guides/data-quality-observability/incident-manager/workflow" >
    Set up the Incident Manager workflow.
  </Card>
 <Card title="Root Cause Analysis (OpenMetadata)" href="/v1.10.x/how-to-guides/data-quality-observability/incident-manager/root-cause-analysis" >
