...
will be shared on its documentation [page](/v1.10.x/connectors/database).
...
You can get details of how to define a yaml file for data profiler for each connector [here](/v1.10.x/connectors/database).
