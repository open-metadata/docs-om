...
1. Use [TestRunner](/v1.10.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner) to validate after loading
...
- Review the [Test Definitions Reference](/v1.10.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-definitions) for all available tests
- Learn about [TestRunner](/v1.10.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner) for validating tables after loading
- Explore [Advanced Usage](/v1.10.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/advanced-usage) patterns and configurations
