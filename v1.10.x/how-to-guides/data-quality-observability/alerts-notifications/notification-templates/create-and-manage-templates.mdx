...
**Check:**
1. Are you using the correct property names? See [Template Context Reference](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)
2. Is the data available for this entity type?
3. Are you using conditionals for optional fields?

## Next Steps

- **Learn about available data** → [Template Context Reference](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)
- **Master Handlebars** → [Handlebars Templating Guide](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
- **Get help with issues** → [Troubleshooting Guide](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/troubleshooting)