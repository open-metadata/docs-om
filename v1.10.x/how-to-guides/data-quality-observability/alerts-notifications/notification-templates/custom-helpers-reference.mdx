...
- **Learn Handlebars basics** → [Handlebars Templating Guide](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
- **Understand available data** → [Template Context Reference](/v1.10.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)