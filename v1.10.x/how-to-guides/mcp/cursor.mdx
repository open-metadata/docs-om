...
slug: /v1.10.x/how-to-guides/mcp/cursor
...
3. **[MCP Application and Personal Access Token](/v1.10.x/how-to-guides/guide-for-data-users/personal-access-token)** - Follow this guide to generate your PAT
...
5. **Token expired**: [Generate a new PAT](/v1.10.x/how-to-guides/guide-for-data-users/personal-access-token) and update your configuration
6. **Restart Cursor** after making configuration changes

## Additional Resources

- [OpenMetadata MCP Documentation](/v1.10.x/how-to-guides/mcp)
