...
Automatically detects the data context of the web application you are working in—such as Tableau, Power BI, Snowflake, or Looker—and surfaces the most relevant datasets, dashboards, and metadata from OpenMetadata without manual search.
...
Mention data owners or stewards, ask questions, or start discussions directly from the extension. Collaborate on metadata without switching to the main OpenMetadata interface.
...
- Visit the Chrome Web Store and search for "OpenMetadata".
