...
Data assets can also be classified using Tiers. Learn more about [Tiers](/v1.10.x/how-to-guides/data-governance/classification/tiers).

Among the Classification Tags, OpenMetadata has some System Classification. Learn more about the [System Tags](/v1.10.x/how-to-guides/data-governance/classification/classification#classification-in-collate).
...
<Card title="How to Request for Tags" href="/v1.10.x/how-to-guides/guide-for-data-users/request-tags" >
