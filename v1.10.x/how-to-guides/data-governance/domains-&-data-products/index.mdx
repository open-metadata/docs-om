...
<CardGroup cols={2}>
<Card title="How to Use Domains" href="/v1.10.x/how-to-guides/data-governance/domains-&-data-products/domains" >
    Learn about the Domains.
  </Card>
 <Card
    title="How to Use Data Products"
    href="/v1.10.x/how-to-guides/data-governance/domains-&-data-products/data-products"
  >
