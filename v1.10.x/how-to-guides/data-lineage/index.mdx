...
<CardGroup cols={2}>
<Card title="Lineage Workflow" href="/v1.10.x/how-to-guides/data-lineage/workflow" >
    Configure a lineage workflow right from the UI.
  </Card>
 <Card title="Explore Lineage" href="/v1.10.x/how-to-guides/data-lineage/explore" >
    Explore the rich lineage view in OpenMetadata.
  </Card>
 <Card title="Column-Level Lineage" href="/v1.10.x/how-to-guides/data-lineage/column" >
    Explore and edit the rich column-level lineage.
  </Card>
 <Card title="Manual Lineage" href="/v1.10.x/how-to-guides/data-lineage/manual" >
