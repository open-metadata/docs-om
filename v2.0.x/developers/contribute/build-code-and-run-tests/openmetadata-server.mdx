...
**Note** To understand more about openmetadata-ops.sh file click [here](/v2.0.x/developers/contribute/build-code-and-run-tests/openmetadata-ops)
...
- You are now ready to explore the app at `http://localhost:8585`. If the web page does not work as intended, see the [troubleshooting steps](/v2.0.x/developers/contribute/build-code-and-run-tests/openmetadata-server#troubleshooting).
...
- If you see a blank page at `http://localhost:8585`, check the logs at `logs/openmetadata.log`. You might be encountering one of the following errors:
  ...
  - Browser console shows javascript errors, try doing a [clean build](/v2.0.x/developers/contribute/build-code-and-run-tests/openmetadata-server#create-a-distribution-packaging). Some npm packages may not have been built properly.
