...
<Card title="OpenMetadata 1.6.0 or later" href="/v2.0.x/deployment" >
...
<Card title="Performance & Memory Management" href="/v2.0.x/developers/contribute/developing-a-new-connector/performance-and-memory">
