...
- [Skills installed](/v2.0.x/developers/contribute/developing-a-new-connector/ai-assisted-development/install-skills) for your AI tool
- Connector [scaffolded](/v2.0.x/developers/contribute/developing-a-new-connector/ai-assisted-development/scaffold-connector) with `metadata scaffold-connector`
