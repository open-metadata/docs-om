...
- [BigQuery](/v2.0.x/connectors/database/bigquery)
- [Clickhouse](/v2.0.x/connectors/database/clickhouse)
- [Databricks](/v2.0.x/connectors/database/databricks)
- [Exasol](/v2.0.x/connectors/database/exasol)
- [MSSQL](/v2.0.x/connectors/database/mssql)
- [PostgreSQL](/v2.0.x/connectors/database/postgres)
- [Redshift](/v2.0.x/connectors/database/redshift)
- [Snowflake](/v2.0.x/connectors/database/snowflake)
...
<CardGroup cols={1}>
<Card title="Usage Workflow through Query Logs" href="/v2.0.x/connectors/ingestion/workflows/usage/usage-workflow-query-logs" >
...
In the [connectors](/v2.0.x/connectors) section we showcase how to run the metadata ingestion from a JSON/YAML file using the Airflow SDK or the CLI via metadata ingest. Running a usage workflow is also possible using a JSON/YAML configuration file.
