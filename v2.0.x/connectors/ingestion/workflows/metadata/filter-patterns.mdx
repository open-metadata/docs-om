...
<CardGroup cols={2}>
  <Card title="Database & Schema Filter Patterns" href="/v2.0.x/connectors/ingestion/workflows/metadata/filter-patterns/database">
    Learn more about how to configure database and schema filters for database sources.
  </Card>
  <Card title="Table Filter Patterns" href="/v2.0.x/connectors/ingestion/workflows/metadata/filter-patterns/table">
