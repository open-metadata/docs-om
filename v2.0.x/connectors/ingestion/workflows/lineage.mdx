...
<CardGroup cols={1}>
<Card title="Lineage Workflow through Query Logs" href="/v2.0.x/connectors/ingestion/workflows/lineage/lineage-workflow-query-logs" >
...
| **Filter Condition** | — | SQL condition applied to the query history result set to exclude specific queries. See [Usage Query Filtering](/v2.0.x/connectors/ingestion/workflows/usage/filter-query-set). |
...
| **Process Cross Database Lineage** | Off | Build lineage across tables in different databases or projects (for example, across BigQuery projects). Also set **Cross Database Service Names** when enabling this option. See [Cross Database Lineage](/v2.0.x/how-to-guides/data-lineage/cross-database-lineage). |
