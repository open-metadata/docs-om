...
- [Troubleshooting](/v2.0.x/connectors/storage/gcs/troubleshooting)
...
You can learn more about this [here](/v2.0.x/connectors/storage). Keep reading for an example on the shape of the manifest file.
