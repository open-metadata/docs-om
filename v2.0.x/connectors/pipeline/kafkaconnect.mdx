...
- [Troubleshooting](/v2.0.x/connectors/pipeline/kafkaconnect/troubleshooting)
...
- **Kafka Service Name**: The Service Name of the ingested [Kafka](/v2.0.x/connectors/messaging/kafka#metadata-ingestion) instance associated with this KafkaConnect instance.
...
* [MySQL](/v2.0.x/connectors/database/mysql)
* [PostgreSQL](/v2.0.x/connectors/database/postgres)
* [MSSQL](/v2.0.x/connectors/database/mssql)
* [MongoDB](/v2.0.x/connectors/database/mongodb)
* [Amazon S3](/v2.0.x/connectors/storage/s3)
