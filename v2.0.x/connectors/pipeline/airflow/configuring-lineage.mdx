...
Regardless of the Airflow ingestion process you follow ([Workflow](/v2.0.x/connectors/pipeline/airflow),
[Lineage Backend](/v2.0.x/connectors/pipeline/airflow/lineage-backend) or [Lineage Operator](/v2.0.x/connectors/pipeline/airflow/lineage-operator)),
