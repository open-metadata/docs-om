...
import ConnectorsList from '/snippets/v2.0.x/connectors/storage/connectors-list.mdx'
...
- Structured data in single and independent files (which can also be ingested with the [S3 Data Lake connector](/v2.0.x/connectors/database/s3-datalake))
