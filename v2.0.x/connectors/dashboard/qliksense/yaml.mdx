...
Refer to the guide on how to generate authentication certificates so that OpenMetadata can communicate with Qlik Sense [here](/v2.0.x/connectors/dashboard/qliksense/certificates).
```yaml
      certificates:
        # pass certificate paths
        clientCertificate: /path/to/client.pem
