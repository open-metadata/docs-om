...
- [Troubleshooting](/v2.0.x/connectors/dashboard/powerbi/troubleshooting)
...
- **Use Admin APIs**: Option for using the PowerBI admin APIs. Refer to the [Power BI Admin and Non-Admin APIs](/v2.0.x/connectors/dashboard/powerbi#powerbi-admin-and-non-admin-apis) section for more information.
