...
**Setup:**
1. Follow [S3 guide](/v2.0.x/connectors/database/dbt/storage-s3-guide) to create bucket and upload artifacts
...
- [Configure dbt Workflow](/v2.0.x/connectors/database/dbt/configure-dbt-workflow)
- [dbt Troubleshooting](/v2.0.x/connectors/database/dbt/dbt-troubleshooting)

<Note>
See other storage options: [S3](/v2.0.x/connectors/database/dbt/storage-s3-guide) | [GCS](/v2.0.x/connectors/database/dbt/storage-gcs-guide) | [Azure](/v2.0.x/connectors/database/dbt/storage-azure-guide) | [Local](/v2.0.x/connectors/database/dbt/storage-local-guide) | [dbt Cloud](/v2.0.x/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
