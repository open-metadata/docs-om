...
<Note>
**This guide is ONLY for dbt Cloud users.** If you're using dbt Core, see [dbt Core Configuration](/v2.0.x/connectors/database/dbt/storage-configuration-overview) for storage setup options.
</Note>
...
- [Ingest dbt Descriptions](/v2.0.x/connectors/database/dbt/ingest-dbt-descriptions)

<Note>
Questions? See the main [dbt Overview](/v2.0.x/connectors/database/dbt) or visit our documentation.
</Note>
