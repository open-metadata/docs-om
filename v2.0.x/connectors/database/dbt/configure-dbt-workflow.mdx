...
See the [Storage Configuration Overview](/v2.0.x/connectors/database/dbt/storage-configuration-overview) for setup guides:
- [AWS S3](/v2.0.x/connectors/database/dbt/storage-s3-guide) | [Google Cloud Storage](/v2.0.x/connectors/database/dbt/storage-gcs-guide) | [Azure Blob](/v2.0.x/connectors/database/dbt/storage-azure-guide) | [HTTP Server](/v2.0.x/connectors/database/dbt/storage-http-guide) | [Local/Shared Filesystem](/v2.0.x/connectors/database/dbt/storage-local-guide)
...
Follow the link [here](/v2.0.x/connectors/database/dbt/setup-multiple-dbt-projects) for instructions on setting up multiple dbt projects.
...
To know how to get the values for `Dbt Cloud Account Id`, `Dbt Cloud Project Id` and `Dbt Cloud Job Id` fields check [here](/v2.0.x/connectors/database/dbt/run-dbt-workflow-externally).
