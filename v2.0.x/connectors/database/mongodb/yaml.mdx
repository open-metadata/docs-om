...
- You can learn more about how to configure and run the Profiler Workflow to extract Profiler data and execute the Data Quality from [here](/v2.0.x/how-to-guides/data-quality-observability/profiler/profiler-workflow)
