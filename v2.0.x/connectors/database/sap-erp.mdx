...
- [Troubleshooting](/v2.0.x/connectors/database/sap-erp/troubleshooting)
...
Follow the guide [here](/v2.0.x/connectors/database/sap-erp/setup-sap-apis) to setup the APIs.
