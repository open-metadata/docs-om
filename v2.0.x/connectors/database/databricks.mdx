...
- [Troubleshooting](/v2.0.x/connectors/database/databricks/troubleshooting)
...
If you are using Unity Catalog in Databricks, then checkout the [Unity Catalog](/v2.0.x/connectors/database/unity-catalog) connector.
