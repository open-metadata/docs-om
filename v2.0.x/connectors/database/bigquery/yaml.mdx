...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v2.0.x/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v2.0.x/connectors/database/bigquery/create-credentials">
...
<DataQuality />
## dbt Integration
You can learn more about how to ingest dbt models' definitions and their lineage [here](/v2.0.x/connectors/database/dbt).
