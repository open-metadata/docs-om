...
import DataProfiler from '/snippets/v2.0.x/connectors/yaml/data-profiler.mdx'
...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v2.0.x/connectors/ingestion/workflows/lineage)
...
## dbt Integration
<Columns cols={2}>
<Card title="dbt Integration" href="/v2.0.x/connectors/database/dbt">
