...
- [Troubleshooting](/v2.0.x/connectors/database/clickhouse/troubleshooting)
...
### Usage & Lineage
For the usage and lineage workflow, the user will need `SELECT` privilege. You can find more information on the usage workflow [here](/v2.0.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v2.0.x/connectors/ingestion/workflows/lineage).
