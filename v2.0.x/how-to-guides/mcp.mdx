...
Learn more about [OAuth 2.0 Authentication](/v2.0.x/how-to-guides/mcp/oauth).
...
1. See [How to Set Up Bots](/v2.0.x/developers/bots) to create a Bot and assign it the role-based access policy your agent needs.
...
<CardGroup cols={2}>
  <Card title="OAuth 2.0 Authentication" href="/v2.0.x/how-to-guides/mcp/oauth">
    Secure, token-free authentication using your existing SSO login.
  </Card>
  <Card title="MCP Server Connection Guide" href="/v2.0.x/how-to-guides/mcp/connect">
    Connect to your MCP Server.
  </Card>
  <Card title="MCP Tools Reference" href="/v2.0.x/how-to-guides/mcp/reference">
    Detailed examples and usage patterns for all available OpenMetadata MCP tools.
  </Card>
  <Card title="Getting Started with Claude Desktop" href="/v2.0.x/how-to-guides/mcp/claude">
    Connect OpenMetadata to Anthropic's popular AI assistant.
  </Card>
  <Card title="Getting Started with Cursor" href="/v2.0.x/how-to-guides/mcp/cursor">
    Connect OpenMetadata to Cursor IDE.
  </Card>
  <Card title="Getting Started with VS Code" href="/v2.0.x/how-to-guides/mcp/vscode">
    Connect OpenMetadata to Visual Studio Code.
  </Card>
  <Card title="Getting Started with Claude Code" href="/v2.0.x/how-to-guides/mcp/claude-code">
    Connect OpenMetadata to Claude Code CLI.
  </Card>
  <Card title="Getting Started with Goose" href="/v2.0.x/how-to-guides/mcp/goose">
    Connect OpenMetadata to Block's open-source AI assistant.
  </Card>
  <Card title="Semantic Search Tool" href="/v2.0.x/how-to-guides/mcp/semantic-search">
