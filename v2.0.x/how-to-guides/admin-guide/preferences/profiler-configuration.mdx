...
These defaults apply to every profiler workflow unless a workflow overrides them. For more information about running the profiler itself, see [Profiler Workflow](/v2.0.x/how-to-guides/data-quality-observability/profiler/profiler-workflow).
