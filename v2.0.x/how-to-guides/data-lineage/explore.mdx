...
To change the default for every session, see [Lineage](/v2.0.x/how-to-guides/admin-guide/preferences/lineage).
...
<Card title="How Column-Level Lineage Works" href="/v2.0.x/how-to-guides/data-lineage/column" >
