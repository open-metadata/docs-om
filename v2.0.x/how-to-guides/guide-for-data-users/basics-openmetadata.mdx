...
- **Announcements:** View all the recent announcements about the data assets you own or follow. Learn [How to Add an Announcement](/v2.0.x/how-to-guides/guide-for-data-users/add-announcement).
- **Following:** View all the data assets that you are following. [Learn How to Follow a Data Asset](/v2.0.x/how-to-guides/guide-for-data-users/follow-data-asset).
