...
- An OpenMetadata [Personal Access Token](/v2.0.x/how-to-guides/mcp#personal-access-token-pat), or an OpenMetadata user account to sign in with if you want per-user OAuth authentication instead.
...
OpenMetadata supports only the `authorization_code` and `refresh_token` grants, so don't select OAuth M2M or `client_credentials`. For a shared, non-interactive credential, use a Personal Access Token instead. For more information, see [OAuth 2.0 Authentication](/v2.0.x/how-to-guides/mcp/oauth).
...
6. Optional: Set **Tools** to the OpenMetadata MCP tools you want to expose. Leave unrestricted to expose all of them. See the [MCP Tools Reference](/v2.0.x/how-to-guides/mcp/reference) for the full list.
...
You should see OpenMetadata's MCP tools (`search_metadata`, `get_entity_details`, and others) in the response. See the [MCP Tools Reference](/v2.0.x/how-to-guides/mcp/reference) for the complete list.
...
6. **Token expired**: [Generate a new PAT](/v2.0.x/how-to-guides/guide-for-data-users/personal-access-token) and update the HTTP connection's credentials.

## Additional Resources

- [OpenMetadata MCP Documentation](/v2.0.x/how-to-guides/mcp)
- [OAuth 2.0 Authentication](/v2.0.x/how-to-guides/mcp/oauth)
- [MCP Tools Reference](/v2.0.x/how-to-guides/mcp/reference)
