...
When you import an ODCS contract, its quality rules that OpenMetadata can run become test cases in this section. For more information, see [ODCS Import and Export](/v2.0.x/how-to-guides/data-contracts/odcs).
