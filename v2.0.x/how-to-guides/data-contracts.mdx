...
<CardGroup cols={2}>
<Card title="OpenMetadata Data Contract Specification" href="/v2.0.x/how-to-guides/data-contracts/spec" >
    Every contract section, the assets that support it, and what a contract run checks
  </Card>
 <Card title="Creating a Data Contract" href="/v2.0.x/how-to-guides/data-contracts/create" >
