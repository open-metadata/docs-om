...
<Card title="Data Asset Import" href="/v2.0.x/how-to-guides/data-discovery/import" >
    Quickly import a data assets as a CSV file.
  </Card>

<Card title="Data Asset Export" href="/v2.0.x/how-to-guides/data-discovery/export" >
