...
- **Learn Handlebars basics** → [Handlebars Templating Guide](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
- **Understand available data** → [Template Context Reference](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)