...
For detailed information about available properties, see [Template Context Reference](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference).
...
- **Explore OpenMetadata's helpers** → [Custom Helpers Reference](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/custom-helpers-reference)
- **Learn available data** → [Template Context Reference](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)