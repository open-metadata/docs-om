...
- **New to templates?** → Start with [Create and Manage Templates](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/create-and-manage-templates)
- **Want to write templates?** → Learn [Handlebars Templating Guide](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
