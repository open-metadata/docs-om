...
- [Column Tests](/v2.0.x/how-to-guides/data-quality-observability/quality/tests-yaml-column-tests)
...
<Card title="Column Tests - YAML Config" href="/v2.0.x/how-to-guides/data-quality-observability/quality/tests-yaml-column-tests">
