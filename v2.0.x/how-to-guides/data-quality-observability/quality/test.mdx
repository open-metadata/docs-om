...
1. Navigate to the table you would like to create a test for. Click the **Data Observability** tab.
2. Click **Add Test** to select a **Table** or **Column** level test.
...
After the test is created, you can view the test case. The test case will be displayed in the **Data Quality** tab. You can also edit the Display Name and Description for the test.
...
3. Set up the scheduler for the desired frequency. The timezone is in UTC.
4. Click **Submit**.
...
If a **test fails**, you can **Edit the Test Status** to New, Ack, or Resolved status by clicking on the **Status** icon.

<img src="/public/images/how-to-guides/quality/test9.png" alt="Failed Test: Edit Status" />

1. Select the Test Status.
    <img src="/public/images/how-to-guides/quality/test10.png" alt="Edit Test Status" />

2. If you are marking the test status as **Resolved**, you must specify the **Reason** for the failure and add a **Comment**. The reasons for failure can be Duplicates, False Positive, Missing Data, Other, or Out of Bounds.
3. Click **Submit**.
    <img src="/public/images/how-to-guides/quality/test11.png" alt="Resolved Status: Reason" />

Users can also set up [alerts](/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) to be notified when a test fails.

## Delete and Restore a Test Case

<Info>
**Note**: Deleting a test case from a table's own **Data Observability** tab is a hard delete. Soft delete and restore are only available from the platform-wide Test Cases list described below.
</Info>

1. Navigate to **Data Observability** > **Data Quality**, and click **Test Cases**.
2. Find the test case and open its row actions menu, then select **Delete**.

    <img src="/public/images/how-to-guides/data-quality-observability/quality/delete-test-case.png" alt="Delete option in the test case row menu" />

3. The **Delete "\<name\>" Test Case** dialog offers two options:
    - **Soft Delete** (selected by default): Turn off this test case. You can restore it later.
    - **Permanently Delete**: Delete this test case and all its metadata forever. This can't be undone.

    Choose **Soft Delete** and click **Delete** to keep the test case's execution history and results while turning it off.

    <img src="/public/images/how-to-guides/data-quality-observability/quality/delete-option-test-case.png" alt="Soft Delete and Permanently Delete options" />

4. Toggle **Show Deleted** on the Test Cases page to find soft-deleted test cases.
5. Open the row actions menu on a deleted test case and select **Restore**, then confirm. The test case becomes editable and resumes on its existing schedule with its history intact.

    <img src="/public/images/how-to-guides/data-quality-observability/quality/restore-test-case.png" alt="Restore option for a soft-deleted test case" />

<Info>
**Note**: Restoring a test case requires **EditAll** permission on test cases. You can also restore a deleted test case from its own details page, which stays read-only until it's restored.
</Info>

 <Card title="How to Set Alerts for Test Case Fails" href="/v2.0.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts" >
