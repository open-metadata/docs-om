...
For table-level tests, see the [Tests UI Overview](/v2.0.x/how-to-guides/data-quality-observability/quality/tests-ui).
...
This test checks that a column never contains empty or missing (NULL) values. It's useful for required fields where a missing value would break downstream reports or logic.
