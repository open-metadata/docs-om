...
<Info>
For column-level tests (null checks, uniqueness, regex, ranges, and more), see [Column-Level Test Definitions](/v2.0.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-definitions/column-tests).
</Info>
