...
<CardGroup cols={2}>
<Card title="Airflow" href="/v2.0.x/deployment/ingestion/external/airflow" >
  ...
  <Card title="GitHub Actions" href="/v2.0.x/deployment/ingestion/external/github-actions" >
