...
[Discovery & Search](/v2.0.x/deployment/upgrade/breaking-changes/discovery-and-search).
...
to be enabled — see
[Platform & Security](/v2.0.x/deployment/upgrade/breaking-changes/platform-and-security).
</Warning>
