...
[Bare Metal deployment](/v2.0.x/deployment/bare-metal) guide.

<Info>
Ready to upgrade? Continue to the [Upgrade Steps](/v2.0.x/deployment/upgrade/bare-metal/steps) for the step-by-step upgrade process and post-upgrade tasks.
</Info>
