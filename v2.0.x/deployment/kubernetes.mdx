...
<CardGroup cols={2}>
<Card title="Helm Values" href="/v2.0.x/deployment/kubernetes/values" >
    For customizing OpenMetadata Helm Deployments
  </Card>
  <Card title="K8s Native Orchestrator" href="/v2.0.x/deployment/ingestion/kubernetes" >
    Run ingestion pipelines as native K8s Jobs (no Airflow required)
  </Card>
  <Card title="Deploy in AWS EKS" href="/v2.0.x/deployment/kubernetes/eks" >
    Deploy OpenMetadata in AWS Kubernetes
  </Card>
  <Card title="Deploy in GCP GKE" href="/v2.0.x/deployment/kubernetes/gke" >
    Deploy OpenMetadata in GCP Kubernetes
  </Card>
  <Card title="Deploy in Azure AKS" href="/v2.0.x/deployment/kubernetes/aks" >
    Deploy OpenMetadata in Azure Kubernetes
  </Card>
  <Card title="Deploy in OnPremises Kubernetes" href="/v2.0.x/deployment/kubernetes/on-prem" >
