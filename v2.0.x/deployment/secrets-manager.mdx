...
- [AWS Secrets Manager](/v2.0.x/deployment/secrets-manager/supported-implementations/aws-secrets-manager)
- [AWS Systems Manager Parameter Store](/v2.0.x/deployment/secrets-manager/supported-implementations/aws-ssm-parameter-store)
