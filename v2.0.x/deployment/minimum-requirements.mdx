...
Please refer to the [architecture section](/v2.0.x/developers/architecture) for more details.
...
Learn more about how to deploy and manage the ingestion workflows [here](/v2.0.x/deployment/ingestion).
