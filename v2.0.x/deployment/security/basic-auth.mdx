...
import ConfigureIngestion from '/snippets/v2.0.x/deployment/configure-ingestion.mdx'
...
configuration. To know how to enable it, you can follow the documentation of [Enable JWT Tokens](/v2.0.x/deployment/security/enable-jwt-tokens).
