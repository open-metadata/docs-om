...
The following values are used when `pipelineServiceClientConfig.type` is set to `k8s`. See the [Kubernetes Orchestrator](/v2.0.x/deployment/ingestion/kubernetes) guide for full documentation.
