...
When clicking on an open incident you will see different information:
...
<CardGroup cols={2}>
<Card title="How to work with the Incident Manager" href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/incident-manager/workflow" >
