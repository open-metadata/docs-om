...
- [Column Tests](/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/tests-ui/column-tests)
...
<Info>
For column-level test configurations in the UI, see [Column Tests - UI Config](/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/tests-ui/column-tests).
</Info>
