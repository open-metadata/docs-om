...
```bash
pip install "openmetadata-ingestion==<your-openmetadata-version>"
```

Secrets manager client libraries are included in the base ingestion package. Install any connector-specific extras required by your test YAML separately, for example `openmetadata-ingestion[mysql,snowflake]==<your-openmetadata-version>`.
...
```bash
pip install "openmetadata-ingestion==<your-openmetadata-version>"
pip install "openmetadata-ingestion[mysql,snowflake,s3]==<your-openmetadata-version>"
```
