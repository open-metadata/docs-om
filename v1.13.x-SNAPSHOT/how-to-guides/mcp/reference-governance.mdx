...
This page covers the governance and lineage MCP tools. For discovery and search tools, see [MCP Tools Reference: Discovery & Search](/v1.13.x-SNAPSHOT/how-to-guides/mcp/reference).
