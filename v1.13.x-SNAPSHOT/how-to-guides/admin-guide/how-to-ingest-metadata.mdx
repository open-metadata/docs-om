...
<Tip>
**Tip:** The **Agents tab** is visible only to users who are an Admin (isAdmin: true), a direct Owner of the service, or a member of an Owner Team.
</Tip>
...
<Tip>
**Note:** Once you’ve run a metadata Agent pipeline, you can create separate pipelines to bring in [**Usage**](/v1.13.x-SNAPSHOT/connectors/ingestion/workflows/usage), [**Lineage**](/v1.13.x-SNAPSHOT/connectors/ingestion/workflows/lineage), [**dbt**](/v1.13.x-SNAPSHOT/connectors/database/dbt), or to run [**Profiler**](/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/profiler-workflow). To add pipelines, select the required type of Agent and enter the required details.
</Tip>
...
<Tip>
**Pro Tip:** Refer to the [Best Practices for Metadata Agent](/v1.13.x-SNAPSHOT/connectors/ingestion/best-practices).
</Tip>
