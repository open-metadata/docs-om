...
To configure the metadat agent, enter and configure the following details and click **Next**:
...
- **Query Definition Parsing Timeout Limit**: Specify the timeout limit for parsing the view definition SQL queries to perform lineage analysis. Defaults to `300`.
