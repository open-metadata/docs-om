...
[Resource scope and operations reference](/v1.13.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies/resource-scope).
...
For a full guide on setting up roles and policies, see [Roles and Policies](/v1.13.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies). Enabling RBAC search makes sure OpenMetadata's search aligns with your organization's data governance and access requirements.
