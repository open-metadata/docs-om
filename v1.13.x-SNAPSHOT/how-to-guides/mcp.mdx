...
Learn more about [OAuth 2.0 Authentication](/v1.13.x-SNAPSHOT/how-to-guides/mcp/oauth).
...
<CardGroup cols={2}>
  <Card title="OAuth 2.0 Authentication" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/oauth">
    Secure, token-free authentication using your existing SSO login.
  </Card>
  <Card title="MCP Server Connection Guide" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/connect">
    Connect to your MCP Server.
  </Card>
  <Card title="MCP Tools Reference" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/reference">
  ...
  <Card title="Getting Started with Cursor" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/cursor">
    Connect OpenMetadata to Cursor IDE.
  </Card>
  <Card title="Getting Started with VS Code" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/vscode">
    Connect OpenMetadata to Visual Studio Code.
  </Card>
  <Card title="Getting Started with Claude Code" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/claude-code">
