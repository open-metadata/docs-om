...
<CardGroup cols={2}>
<Card title="OpenMetadata MCP Server Connection Guide" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="OpenMetadata MCP Tools Reference" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/reference" >
    Detailed examples and usage patterns for all available OpenMetadata MCP tools.
  </Card>
 <Card title="Getting Started with Claude Desktop" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/claude" >
    Connect your OpenMetadata to Anthropic's popular AI assistant.
  </Card>
 <Card title="Getting Started with Goose" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/goose" >
    Connect your OpenMetadata to Block's Open-Source AI assistant.
  </Card>
 <Card title="Semantic Search Tool" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp/semantic-search" >
