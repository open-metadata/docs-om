...
<Card title="Performance & Memory Management" href="/v1.13.x-SNAPSHOT/developers/contribute/developing-a-new-connector/performance-and-memory">
  Learn pagination, memory management, and connection reuse patterns required for production connectors.
</Card>
