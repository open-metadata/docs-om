...
<Card title="Invoke Agent" icon="message-bot" href="/v1.13.x-SNAPSHOT/api-reference/sdk/ai/invoke">
  Send a message to an AI Studio Agent and get a response, with optional streaming and multi-turn conversations.
</Card>

<Card title="Create Agent" icon="robot" href="/v1.13.x-SNAPSHOT/api-reference/sdk/ai/create-agent">
  Programmatically create an AI Studio Agent with a persona, abilities, and API access.
</Card>

<Card title="Create Persona" icon="user-gear" href="/v1.13.x-SNAPSHOT/api-reference/sdk/ai/create-persona">
  Create and manage personas that define the behavior and personality of AI Studio Agents.
</Card>

<Card title="MCP Tools" icon="wrench" href="/v1.13.x-SNAPSHOT/api-reference/sdk/ai/mcp-tools">
