...
# List first page
topics = ometa.list_entities(entity=Topic, limit=50)
for t in topics.entities:
    print(f"{t.fullyQualifiedName}")

# List all with cursor pagination
after = None
while True:
    page = ometa.list_entities(entity=Topic, limit=50, after=after)
...
# Filter by service
topics = ometa.list_entities(
    entity=Topic,
    fields=["owners", "tags", "domains"],
    params={"service": "sample_kafka"},
    limit=50,
)
