...
[here](/v1.13.x-SNAPSHOT/deployment/security/enable-ssl), and it should be the local path
...
Email Address []:local@open-metadata.org
```
...
```
Please make sure to have the truststore file mounted and available as part of Docker Deployments.
