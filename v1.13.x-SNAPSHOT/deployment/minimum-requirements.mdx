...
Please refer to the [architecture section](/v1.13.x-SNAPSHOT/developers/architecture) for more details.
...
<Note>
For enterprise use cases with heavy workloads, we recommend 150–200 GB of storage to accommodate larger datasets and transaction volumes.
</Note>
...
Learn more about how to deploy and manage the ingestion workflows [here](/v1.13.x-SNAPSHOT/deployment/ingestion).
