...
- 4 vCPUs
- 16 GiB Memory
- 100 GiB Storage (minimum)

<Note>
For heavy workloads or enterprise use cases, you may require up to 200 GB of storage to accommodate larger datasets and transaction volumes.
</Note>
