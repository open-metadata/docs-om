...
<Info>
For code examples running Metadata, Lineage, Usage, Profiler, and Data Quality workflows externally, see [Workflow Examples](/v1.13.x-SNAPSHOT/deployment/ingestion/external/examples).
</Info>
