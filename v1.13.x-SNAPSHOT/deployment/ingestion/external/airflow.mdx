...
OpenMetadata integrates with Airflow to orchestrate ingestion workflows. You can use Airflow to [extract metadata](/v1.13.x-SNAPSHOT/connectors/pipeline/airflow) and [deploy workflows] (/deployment/ingestion/openmetadata) directly. This guide explains how to run ingestion workflows in Airflow using three different operators:
...
<Card title="Docker & Virtualenv Operators" href="/v1.13.x-SNAPSHOT/deployment/ingestion/external/airflow-docker-virtualenv">
