...
[Kubernetes Deployment](/v1.13.x-SNAPSHOT/deployment/kubernetes) guide.
...
You can learn more about how the migration process works [here](/v1.13.x-SNAPSHOT/deployment/upgrade/how-does-it-work).
