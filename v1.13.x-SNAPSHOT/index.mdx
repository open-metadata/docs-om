...
import { Integrations } from "/snippets/v1.13.x-SNAPSHOT/components/ConnectorGrid/Integration.jsx"
...
<a href="/v1.13.x-SNAPSHOT/connectors/database/databricks" className="chip purple">
  <Icon icon="/public/images/connectors/databrick.webp" color="#6938EF" /> <span>Databricks</span>
</a>

<a href="/v1.13.x-SNAPSHOT/connectors/database/bigquery" className="chip purple">
  <Icon icon="/public/images/connectors/bigquery.webp" color="#6938EF" /> <span>BigQuery</span>
</a>

<a href="/v1.13.x-SNAPSHOT/connectors/database/redshift" className="chip purple">
  <Icon icon="/public/images/connectors/redshift.webp" color="#6938EF" /> <span>Redshift</span>
</a>

<a href="/v1.13.x-SNAPSHOT/connectors/database/snowflake" className="chip purple">
  <Icon icon="/public/images/connectors/snowflakes.webp" color="#6938EF" /> <span>Snowflake</span>
</a>
<a href="/v1.13.x-SNAPSHOT/how-to-guides/mcp" className="chip purple">
  <Icon icon="/public/images/icons/mcp.svg" color="#6938EF" /> <span>MCP</span>
</a>

<a href="/v1.13.x-SNAPSHOT/sdk/ai-sdk" className="chip purple">
...
<a className="read-more" href="/v1.13.x-SNAPSHOT/quick-start">
    <span>Read More</span>
...
<a className="read-more" href="/v1.13.x-SNAPSHOT/deployment">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
...
<a className="read-more" href="/v1.13.x-SNAPSHOT/deployment/upgrade">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
...
<a href="https://getcollate.io/" target="_blank">Explore Collate</a>
</div>
...
<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-discovery" className="guide-card">
  <Icon icon="/public/images/homepage-icons/discovery.svg" />
  <div>Discovery</div>
</a>

<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-lineage" className="guide-card">
  <Icon icon="/public/images/homepage-icons/lineage.svg" />
  <div>Lineage</div>
</a>

<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability" className="guide-card">
  <Icon icon="/public/images/homepage-icons/observability.svg" />
  <div>Observability</div>
</a>

<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-insights" className="guide-card">
  <Icon icon="/public/images/homepage-icons/insights.svg" />
  <div>Insights</div>
</a>

<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-contracts" className="guide-card">
  <Icon icon="/public/images/homepage-icons/contract.svg" />
  <div>Data Contract</div>
</a>

<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-governance" className="guide-card">
  <Icon icon="/public/images/homepage-icons/governance.svg" />
  <div>Governance</div>
</a>

<a href="/v1.13.x-SNAPSHOT/connectors" className="guide-card">
...
<a href="/v1.13.x-SNAPSHOT/how-to-guides">See All</a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.13.x-SNAPSHOT/sdk/ai-sdk">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.13.x-SNAPSHOT/how-to-guides/mcp">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/dimensional-validation">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<a href="/v1.13.x-SNAPSHOT/sdk/ai-sdk">AI SDK</a>
<a href="/v1.13.x-SNAPSHOT/how-to-guides/mcp">MCP Server</a>
<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-contracts">Data Contracts</a>
<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code">Data Quality as Code</a>
<a href="/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/dimensional-validation">Dimensional Validation</a>
</div>
</div>
