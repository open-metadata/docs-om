...
The default Metadata Ingestion runs sequentially. This feature allows you to run the ingestion concurrently using [Threading](https://docs.python.org/3/library/threading.html).
