...
<ContentSection id={12} title="consumerConfigSSL" lines="17-19">
**consumerConfigSSL**: SSL configuration for the broker consumer connection. Provide `caCertificate`, `sslCertificate`, and `sslKey` for mTLS authentication.
</ContentSection>
<ContentSection id={13} title="schemaRegistrySSL" lines="20-22">
**schemaRegistrySSL**: SSL configuration for the Schema Registry connection. Provide `caCertificate`, `sslCertificate`, and `sslKey` for mTLS authentication.
</ContentSection>
<ContentSection id={14} title="redpandaAdminApiUrl" lines="23">
**redpandaAdminApiUrl**: URL of the Redpanda Admin API (typically port 9644). Required for extracting data transform lineage. Example: `http://localhost:9644`
</ContentSection>
</ContentPanel>
...
source:
  ...
  serviceConnection:
    config:
      ...
      # schemaRegistrySSL:
      #   caCertificate: "-----BEGIN CERTIFICATE-----\n...\n-----END CERTIFICATE-----"
      # redpandaAdminApiUrl: http://localhost:9644
