...
name="MySQL"
stage="PROD"
availableFeatures={["Metadata", "Data Profiler", "Data Quality", "dbt", "View Lineage", "View Column-level Lineage", "Query Usage", "Sample Data", "Reverse Metadata (OpenMetadata Only)", "Auto-Classification", "Stored Procedures"]}
...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v1.13.x-SNAPSHOT/connectors/ingestion/workflows/lineage)
