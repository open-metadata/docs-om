...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.13.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
- [Troubleshooting](/v1.13.x-SNAPSHOT/connectors/database/bigquery/troubleshooting)

<ExternalIngestionDeployment />
## Requirements
You need to create an service account in order to ingest metadata from bigquery refer [this](/v1.13.x-SNAPSHOT/connectors/database/bigquery/create-credentials) guide on how to create service account.
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v1.13.x-SNAPSHOT/connectors/database/bigquery/create-credentials">
