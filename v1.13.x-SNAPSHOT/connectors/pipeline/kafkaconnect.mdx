...
- [Troubleshooting](/v1.13.x-SNAPSHOT/connectors/pipeline/glue-pipeline/troubleshooting)
...
- **Kafka Service Name** : The Service Name of the Ingested [Kafka](/v1.13.x-SNAPSHOT/connectors/messaging/kafka#4.-name-and-describe-your-service) instance associated with this KafkaConnect instance.
</Step>
<TestConnection />
<ConfigureIngestion />
...
* [MySQL](/v1.13.x-SNAPSHOT/connectors/database/mysql)
* [PostgreSQL](/v1.13.x-SNAPSHOT/connectors/database/postgres)
* [MSSQL](/v1.13.x-SNAPSHOT/connectors/database/mssql)
* [MongoDB](/v1.13.x-SNAPSHOT/connectors/database/mongodb)
* [Amazon S3](/v1.13.x-SNAPSHOT/connectors/storage/s3)
