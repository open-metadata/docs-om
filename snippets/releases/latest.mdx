<Update label="Latest Release" description="22nd February 2026">

You can find the GitHub release [here](https://github.com/open-metadata/OpenMetadata/releases/tag/1.12.0-release).
...
**Full Changelog**: [link](https://github.com/open-metadata/OpenMetadata/compare/1.11.10-release...1.12.0-release)
