...
- **Python 3.12**: Ingestion images now run on Python 3.12 (`python:3.12-slim-trixie`). Custom ingestion images or Airflow environments pinned to Python 3.10 must be rebuilt — `cp310` wheels will not load.
