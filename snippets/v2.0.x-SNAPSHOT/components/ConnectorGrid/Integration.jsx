...
export const Integrations = () => {
    const INTEGRATION_SERVICES = [
            ...
            services: [
                {
                    ...
                    link: '/v2.0.x-SNAPSHOT/connectors/api/rest',
                },
            ],
        },
        {
            connector: 'Database',
            services: [
                { name: 'Athena', image: '/public/images/connectors/athena.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/athena' },
                { name: 'Azure SQL', image: '/public/images/connectors/azuresql.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/azuresql' },
                { name: 'BigQuery', image: '/public/images/connectors/bigquery.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/bigquery' },
                { name: 'BigTable', image: '/public/images/connectors/big-table.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/bigtable' },
                { name: 'Cassandra', image: '/public/images/connectors/cassandra.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/cassandra' },
                { name: 'ClickHouse', image: '/public/images/connectors/clickhouse.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/clickhouse' },
                { name: 'Cockroach', image: '/public/images/connectors/cockroach.png', link: '/v2.0.x-SNAPSHOT/connectors/database/cockroach' },
                { name: 'Couchbase', image: '/public/images/connectors/couchbase.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/couchbase' },
                { name: 'Delta Lake', image: '/public/images/connectors/delta-lake.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/deltalake' },
                { name: 'Druid', image: '/public/images/connectors/druid.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/druid' },
                { name: 'S3 Datalake', image: '/public/images/connectors/amazon-s3.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/s3-datalake' },
                { name: 'ADLS Datalake', image: '/public/images/connectors/adls.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/adls-datalake' },
                ...
                { name: 'Exasol', image: '/public/images/connectors/exasol.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/exasol' },
                { name: 'Glue', image: '/public/images/connectors/glue.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/glue' },
                ...
                { name: 'MySQL', image: '/public/images/connectors/sql.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/mysql' },
                { name: 'Oracle', image: '/public/images/connectors/oracle.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/oracle' },
                { name: 'PostgreSQL', image: '/public/images/connectors/post.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/postgres' },
                { name: 'Presto', image: '/public/images/connectors/presto.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/presto' },
                { name: 'Redshift', image: '/public/images/connectors/redshift.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/redshift' },
                { name: 'Salesforce', image: '/public/images/connectors/salesforce.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/salesforce' },
                { name: 'SAP ERP', image: '/public/images/connectors/sap-erp.png', link: '/v2.0.x-SNAPSHOT/connectors/database/sap-erp' },
                { name: 'SAP HANA', image: '/public/images/connectors/sap-hana.png', link: '/v2.0.x-SNAPSHOT/connectors/database/sap-hana' },
                { name: 'Snowflake', image: '/public/images/connectors/snowflakes.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/snowflake' },
                { name: 'SingleStore', image: '/public/images/connectors/singlestore.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/singlestore' },
                { name: 'Teradata', image: '/public/images/connectors/teradata.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/teradata' },
                { name: 'TimescaleDB', image: '/public/images/connectors/timescale.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/timescale' },
                { name: 'Trino', image: '/public/images/connectors/trino.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/trino' },
                { name: 'Unity Catalog', image: '/public/images/connectors/databrick.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/unity-catalog' },
                { name: 'Vertica', image: '/public/images/connectors/vertica.webp', link: '/v2.0.x-SNAPSHOT/connectors/database/vertica' },
        ...
        },
        {
            connector: 'Dashboard',
            services: [
                { name: 'Lightdash', image: '/public/images/connectors/lightdash.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/lightdash' },
                { name: 'Grafana', image: '/public/images/connectors/grafana.png', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/grafana' },
                { name: 'Hex', image: '/public/images/connectors/hex.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/hex' },
                { name: 'Looker', image: '/public/images/connectors/looker.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/looker' },
                ...
                { name: 'Sigma', image: '/public/images/connectors/sigma.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/sigma' },
                { name: 'Superset', image: '/public/images/connectors/superset.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/superset' },
                { name: 'Tableau', image: '/public/images/connectors/tableau.webp', link: '/v2.0.x-SNAPSHOT/connectors/dashboard/tableau' },
        ...
        },
        {
            connector: 'Pipeline',
            services: [
                { name: 'Airflow', image: '/public/images/connectors/airflow.webp', link: '/v2.0.x-SNAPSHOT/connectors/pipeline/airflow' },
                { name: 'Airbyte', image: '/public/images/connectors/airbyte.webp', link: '/v2.0.x-SNAPSHOT/connectors/pipeline/airbyte' },
        ...
        },
        {
            connector: 'ML Model',
            services: [
                { name: 'MLflow', image: '/public/images/connectors/mlflow.webp', link: '/v2.0.x-SNAPSHOT/connectors/ml-model/mlflow' },
                { name: 'SageMaker', image: '/public/images/connectors/sagemaker.webp', link: '/v2.0.x-SNAPSHOT/connectors/ml-model/sagemaker' },
            ],
        },
        {
            connector: 'Search',
            services: [
                { name: 'Elasticsearch', image: '/public/images/connectors/elasticsearch.webp', link: '/v2.0.x-SNAPSHOT/connectors/search/elasticsearch' },
                { name: 'OpenSearch', image: '/public/images/connectors/opensearch.webp', link: '/v2.0.x-SNAPSHOT/connectors/search/opensearch' },
            ],
        },
        {
            connector: 'Storage',
            services: [
                { name: 'GCS', image: '/public/images/connectors/gcs.webp', link: '/v2.0.x-SNAPSHOT/connectors/storage/gcs' },
                { name: 'S3 Storage', image: '/public/images/connectors/amazon-s3.webp', link: '/v2.0.x-SNAPSHOT/connectors/storage/s3' },
            ],
        },
        {
            connector: 'Metadata',
