...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.11.x/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-pg_trgm-extension-requirement) section.
