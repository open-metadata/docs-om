...
<CardGroup cols={1}>
<Card title="Backup Metadata" href="/v1.11.x/deployment/backup-restore-metadata" >
...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.11.x/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-flexible-server--pg_trgm-extension-requirement) section.
