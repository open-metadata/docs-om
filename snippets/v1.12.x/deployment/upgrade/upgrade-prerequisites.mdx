...
<BreakingChanges>
- **OpenSearch/Elasticsearch Client Upgrade:** The search client libraries have been upgraded. If you are using custom integrations, you must update to **Elasticsearch 9.3.0** or **OpenSearch 3.4.0**.
