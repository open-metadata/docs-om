...
<BreakingChanges>
- **OpenSearch/Elasticsearch Client Upgrade:** The search client libraries have been upgraded. You must upgrade your search indexes to **Elasticsearch 9.3.0** or **OpenSearch 3.3.0** or higher. If using AWS OpenSearch, you might not be able to upgrade from 2.X into 3.3 directly. In this case, create a fresh installation with 3.3 and run a reindex. All the index data will be repopulated.
