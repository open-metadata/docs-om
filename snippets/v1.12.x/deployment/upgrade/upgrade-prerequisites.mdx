...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.12.x/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-flexible-server--pg_trgm-extension-requirement) section.
