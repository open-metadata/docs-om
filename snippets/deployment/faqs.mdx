...
Review the [tested custom connector examples](https://github.com/open-metadata/OpenMetadata/tree/main/ingestion/tests/integration/custom_connectors) for complete implementations. After you have your code ready, the steps would be the following:
