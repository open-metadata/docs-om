...
TimescaleDB supports description updates at all levels:
- Database level
- Schema level
- Table level
- Column level
...
TimescaleDB supports owner management at the following levels:
- Database level
- Schema level
- Table level
...
❌ Tag management is not supported for TimescaleDB.

### Custom SQL Template

TimescaleDB supports custom SQL templates for metadata changes. The template is interpreted using python f-strings.
