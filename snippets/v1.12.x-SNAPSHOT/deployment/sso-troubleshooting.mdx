...
<CardGroup cols={2}>
  <Card
    ...
    href="/v1.12.x-SNAPSHOT/deployment/docker/security"
  >
  ...
  <Card
    ...
    href="/v1.12.x-SNAPSHOT/deployment/bare-metal/security"
  >
  ...
  <Card
    ...
    href="/v1.12.x-SNAPSHOT/deployment/kubernetes/security"
  >
