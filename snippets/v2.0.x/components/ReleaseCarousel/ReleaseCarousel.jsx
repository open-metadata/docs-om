    ...
    const SLIDES = [
        {
            ...
            link: '/v2.0.x/releases/2.0-release',
        },
        {
            header: 'Explore Page',
            ...
            link: '/v2.0.x/deployment/upgrade/breaking-changes/discovery-and-search',
        },
        {
            ...
            link: '/v2.0.x/releases/2.0-release#context-center',
        },
        {
            ...
            link: '/v2.0.x/releases/2.0-release#landing-page',
        },
    ]
