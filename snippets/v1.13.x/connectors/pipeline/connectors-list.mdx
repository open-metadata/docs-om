...
<Card title="Dagster" icon="/public/images/connectors/dagster.webp" href="/v1.13.x/connectors/pipeline/dagster" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
<Card title="Databricks" icon="/public/images/connectors/databrick.webp" href="/v1.13.x/connectors/pipeline/databricks-pipeline" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
...
<Card title="Fivetran" icon="/public/images/connectors/fivetran.webp" href="/v1.13.x/connectors/pipeline/fivetran" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
<Card title="Flink" icon="/public/images/connectors/flink.png" href="/v1.13.x/connectors/pipeline/flink" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
<Card title="Glue" icon="/public/images/connectors/glue.webp" href="/v1.13.x/connectors/pipeline/glue-pipeline" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
<Card title="KafkaConnect" icon="/public/images/connectors/kafka.webp" href="/v1.13.x/connectors/pipeline/kafkaconnect" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
</Card>
<Card title="NiFi" icon="/public/images/connectors/apachenifi.webp" href="/v1.13.x/connectors/pipeline/nifi" horizontal >
  <div className="prod-beta-chip prod"><img src="/public/images/icons/prod-icon.svg" alt="prod" noZoom /> <div>PROD</div></div>
  </Card>
