...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.13.x-SNAPSHOT/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-pg_trgm-extension-requirement) section.
