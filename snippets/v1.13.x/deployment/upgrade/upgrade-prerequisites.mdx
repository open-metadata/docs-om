...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.13.x-SNAPSHOT/deployment/upgrade/kubernetes#azure-postgresql-flexible-server--pg_trgm-extension-requirement) section.
