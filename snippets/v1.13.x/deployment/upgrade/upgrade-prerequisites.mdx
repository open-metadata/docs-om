...
<CardGroup cols={1}>
<Card title="Backup Metadata" href="/v1.12.x-SNAPSHOT/deployment/backup-restore-metadata" >
...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.13.x-SNAPSHOT/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-flexible-server--pg_trgm-extension-requirement) section.
