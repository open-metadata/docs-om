...
<CardGroup cols={1}>
<Card title="Backup Metadata" href="/v1.13.x/deployment/backup-restore-metadata" >
...
For detailed troubleshooting, see the [Kubernetes Upgrade Troubleshooting](/v1.13.x/deployment/upgrade/kubernetes-troubleshooting#azure-postgresql-pg_trgm-extension-requirement) section.
