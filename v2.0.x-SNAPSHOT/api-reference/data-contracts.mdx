...
<Card title="Create Contract" icon="plus" href="/v1.13.x-SNAPSHOT/api-reference/data-contracts/create">
  Create a new data contract for an entity.
</Card>

<Card title="List Contracts" icon="list" href="/v1.13.x-SNAPSHOT/api-reference/data-contracts/list">
  List and filter data contracts.
</Card>

<Card title="Retrieve Contract" icon="eye" href="/v1.13.x-SNAPSHOT/api-reference/data-contracts/retrieve">
  Get a contract by ID, FQN, or entity.
</Card>

<Card title="Validate" icon="check" href="/v1.13.x-SNAPSHOT/api-reference/data-contracts/validate">
  Validate contracts and view execution results.
</Card>

<Card title="Import & Export" icon="arrows-rotate" href="/v1.13.x-SNAPSHOT/api-reference/data-contracts/odcs">
