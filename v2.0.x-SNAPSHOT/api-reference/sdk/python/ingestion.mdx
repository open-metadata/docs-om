...
<CardGroup cols={2}>
<Card title="Add Lineage Request" href="/v2.0.x-SNAPSHOT/api-reference/sdk/python/ingestion/lineage" >
    Learn how to use the Python client to interact with the Lineage.
  </Card>
  <Card title="Tags" href="/v2.0.x-SNAPSHOT/api-reference/sdk/python/ingestion/tags" >
