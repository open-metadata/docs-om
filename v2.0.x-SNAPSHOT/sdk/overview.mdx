...
<CardGroup cols={3}>
  <Card title="Python SDK" icon="/public/images/icons/puzzle.svg" href="/v1.13.x-SNAPSHOT/sdk/python/overview">
    Full-featured Python client
  </Card>
  <Card title="Java SDK" icon="/public/images/icons/puzzle.svg" href="/v1.13.x-SNAPSHOT/sdk/java">
    Enterprise Java integration
  </Card>
  <Card title="Go SDK" icon="/public/images/icons/puzzle.svg" href="/v1.13.x-SNAPSHOT/sdk/go">
