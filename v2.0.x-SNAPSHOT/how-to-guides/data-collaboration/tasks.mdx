...
<Card title="How to Request for Description" href="/v1.13.x-SNAPSHOT/how-to-guides/data-collaboration/request-description" >
    Request for a description and discuss the same within OpenMetadata
  </Card>

<Card title="How to Request for Tags" href="/v1.13.x-SNAPSHOT/how-to-guides/data-collaboration/request-tags" >
