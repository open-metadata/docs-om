...
- [Goose Desktop](https://block-goose.mintlify.app/configuration)
- OpenMetadata [MCP Application and Personal Access Token](https://docs.open-metadata.org/v2.0.x-SNAPSHOT/how-to-guides/mcp#installing-mcp-server)

## Adding your OpenMetadata MCP Server to Goose Desktop
This how-to guide uses Goose Desktop for macOS. Make sure that you already have an [LLM provider configured](https://block-goose.mintlify.app/configuration#provider-configuration) before prompting.
