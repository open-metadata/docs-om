...
- An OpenMetadata [Personal Access Token](/v2.0.x-SNAPSHOT/how-to-guides/mcp#personal-access-token-pat), or OAuth client credentials, if you want per-user authentication instead.
...
1. In the left sidebar, select **AI Gateway > MCPs**.
