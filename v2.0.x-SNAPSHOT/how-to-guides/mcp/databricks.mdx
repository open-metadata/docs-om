...
If your policy requires **OAuth U2M** instead, register a client through `https://<YOUR-OPENMETADATA-SERVER>/mcp/register` and allowlist `https://<YOUR-DATABRICKS-WORKSPACE>/login/oauth/http.html`. Configure Databricks with:
