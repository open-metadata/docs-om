...
### 2. Authentication
The MCP server requires [JWT authentication](/v2.0.x-SNAPSHOT/how-to-guides/mcp#adding-a-personal-access-token-to-your-mcp-client). Include your token in the Authorization header:
```http
