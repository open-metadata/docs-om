...
- A [Personal Access Token](/v2.0.x-SNAPSHOT/how-to-guides/mcp#adding-a-personal-access-token-to-your-mcp-client)
  for authentication
...
### No results returned
- Check that the `vector_search_index` exists in your search backend and contains documents.
