...
The Semantic Search tool extends OpenMetadata's [MCP Server](/v2.0.x-SNAPSHOT/how-to-guides/mcp) with the ability to
...
- Semantic Search [enabled and configured](/v2.0.x-SNAPSHOT/deployment/semantic-search) in your deployment
- The [MCP Application installed](/v2.0.x-SNAPSHOT/how-to-guides/mcp#installing-mcp-server) in OpenMetadata
- A [Personal Access Token](/v2.0.x-SNAPSHOT/how-to-guides/mcp#personal-access-token-pat)
  for authentication
...
- Ensure entities have been embedded by running a Reindex from the OpenMetadata UI. See the
  [deployment guide](/v2.0.x-SNAPSHOT/deployment/semantic-search#generating-embeddings) for details.
