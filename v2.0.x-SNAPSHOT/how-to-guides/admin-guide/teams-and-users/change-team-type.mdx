...
Refer to the [**Team Structure in OpenMetadata**](/v1.13.x-SNAPSHOT/how-to-guides/admin-guide/teams-and-users/team-structure-openmetadata) to get a clear understanding of the various **Team Types**.
