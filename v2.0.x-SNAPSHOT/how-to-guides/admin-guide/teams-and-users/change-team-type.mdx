...
Refer to the [**Team Structure in OpenMetadata**](/v2.0.x-SNAPSHOT/how-to-guides/admin-guide/teams-and-users/team-structure-openmetadata) to get a clear understanding of the various **Team Types**.
