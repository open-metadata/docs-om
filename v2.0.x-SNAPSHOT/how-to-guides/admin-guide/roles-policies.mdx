...
<Card title="Building Blocks of Authorization: Rules, Policies, and Roles" href="/v2.0.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies/authorization" >
    Learn all the details of Rules, Policies, and Roles
  </Card>

<Card title="Use Cases: Creating Roles & Policies in OpenMetadata" href="/v2.0.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies/use-cases" >
