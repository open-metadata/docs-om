...
<CardGroup cols={2}>
<Card title="How to Discover Assets of Interest" href="/v2.0.x-SNAPSHOT/how-to-guides/data-discovery/discover" >
    Discover the right data assets quickly.
  </Card>
 <Card title="Get a Quick Glance of the Data Assets" href="/v2.0.x-SNAPSHOT/how-to-guides/data-discovery/preview" >
    Quick preview of the selected data asset.
  </Card>
 <Card title="Data Asset Details" href="/v2.0.x-SNAPSHOT/how-to-guides/data-discovery/details" >
    Get a holistic view of the data assets.
  </Card>
 <Card title="Using Advanced Search" href="/v2.0.x-SNAPSHOT/how-to-guides/data-discovery/advanced" >
