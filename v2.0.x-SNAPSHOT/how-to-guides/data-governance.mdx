...
<CardGroup cols={3}>
<Card title="Glossary" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary" >
    Set up business glossaries in OpenMetadata.
  </Card>
 <Card title="Classification" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/classification" >
    Learn about the classification tags.
  </Card>
 <Card title="Domains & Data Products" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/domains-&-data-products" >
