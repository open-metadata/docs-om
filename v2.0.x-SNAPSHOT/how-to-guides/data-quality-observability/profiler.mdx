...
<CardGroup cols={2}>
<Card title="Profiler Tab" href="/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/tab" >
 ...
 <Card title="Metrics" href="/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/metrics" >
    Learn about the supported profiler metrics.
  </Card>
 <Card title="Auto Pii Tagging" href="/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/auto-pii-tagging" >
    Automatically detect and tag columns containing sensitive PII data during profiling.
  </Card>
 <Card title="Spark Engine" href="/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/spark-engine" >
