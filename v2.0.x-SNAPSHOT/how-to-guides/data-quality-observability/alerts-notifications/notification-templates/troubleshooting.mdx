...
1. **Verify property names**
   - Check [Template Context Reference](/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)
...
**Solution:**
- Check [Custom Helpers Reference](/v1.13.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/custom-helpers-reference)
