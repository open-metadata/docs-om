...
## Bulk Export Test Case for a Table
...
5. Complete steps 5 to 6 from [Bulk Export Test Case for a Table](#bulk-export-test-case-for-a-table).
...
1. Navigate to **Data Observability** > **Data Quality**, and click **Test Cases**.
    <img src="/public/images/how-to-guides/data-quality-observability/quality/select-export-test-cases.png" alt="Test Cases Tab" />
...
3. Complete steps 5 to 6 from [Bulk Export Test Case for a Table](#bulk-export-test-case-for-a-table).
