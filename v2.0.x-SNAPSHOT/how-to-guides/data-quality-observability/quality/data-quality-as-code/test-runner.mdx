...
<Note>
⚠️ If you're using OpenMetadata Cloud to run OpenMetadata, please refer to [External Secrets Managers](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner/external-secrets) before using the TestRunner API.
</Note>
...
<Info>
If your organization uses an external secrets manager (AWS, Azure, GCP), see [External Secrets Managers](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner/external-secrets) before using the TestRunner API.
</Info>

## Next Steps

- Learn about [DataFrame Validation](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/dataframe-validation) for validating transformations
- Review the [Test Definitions Reference](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-definitions) for all available tests
- Explore [Advanced Usage](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/advanced-usage) including YAML workflows
