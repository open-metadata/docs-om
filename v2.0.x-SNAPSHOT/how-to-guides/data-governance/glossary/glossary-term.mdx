...
Each term has a **life cycle status** (e.g., Draft, Approved). Glossary terms can be added manually. You can also [export or bulk import the glossary terms](/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/import) using a CSV file.
...
<Card title="How to Setup a Glossary" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/setup" >
