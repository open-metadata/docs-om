...
If the Owner and Reviewer details are added while creating the glossary, and the glossary terms are **[bulk uploaded using a CSV file](/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/import)**, then the glossary Owner and Reviewers are inherited for all the glossary terms. These details can be changed later.

<Card title="How to Create Glossary Terms" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/create-terms" >
    Setup Glossary Terms to define the terminology. Add tags, synonyms, related terms, links, etc.
  </Card>

<Card title="How to Bulk Import a Glossary" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/import" >
    Save time and effort by bulk uploading glossary terms using a CSV file.
  </Card>

<Card title="How to Add Assets to Glossary Terms" href="/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/assets" >
