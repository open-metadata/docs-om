...
<CardGroup cols={2}>
<Card title="What is Tiering" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/tiering" >
    Set business importance of data using Tiers.
  </Card>
 <Card title="Set Up Data Insights Ingestion" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/ingestion" >
    Set up the ingestion pipeline right from the UI.
  </Card>
 <Card title="Key Performance Indicators (KPI)" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/kpi" >
    Define the KPIs and set goals for documentation, and ownership.
  </Card>
 <Card title="Data Insights Report" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/report" >
    Get a quick glance of data asset description, ownership, and tiering coverage.
  </Card>
 <Card title="Configure the Data Insights Report" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/email-report" >
    Email the report to Admins and Teams at the desired frequency.
  </Card>
 <Card title="How to Transform the Data Culture of Your Company" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/data-culture" >
    Improve your data culture for data-driven decision making.
  </Card>
  <Card title="Service Insights and Monitoring in OpenMetadata" href="/v2.0.x-SNAPSHOT/how-to-guides/data-insights/service-insights" >
