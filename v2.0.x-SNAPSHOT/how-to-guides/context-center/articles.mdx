---
title: Articles
description: Long-form pages your team writes and maintains, indexed for AI assistants to search.
sidebarTitle: Articles
---

# Articles

Articles are Context Center's internal knowledge base: long-form pages your team writes, organizes, and maintains, authored for people and indexed for AI assistants connected via MCP to search. Use them for durable, structured knowledge that's worth maintaining as a page, such as data governance policies, classification standards, incident playbooks, or internal API documentation.
...
2. Click **Create** and choose:
    ...
    - **Quick Link**: Bookmarks an external URL as an article instead of writing new content. Add a title, description, the target URL, an owner or team, and tags.
...
- **Header information**: The article's domain, owner, and reviewer (once one is assigned), each shown as a chip you can edit inline by clicking the pencil icon next to it.
...
- **Toolbar actions**, next to the Saved indicator:
  ...
  - **Copy**: Use the copy icon to copy and paste the article.
