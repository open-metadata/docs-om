...
<CardGroup cols={2}>
  <Card title="Airflow Orchestrator" href="/v2.0.x-SNAPSHOT/deployment/ingestion/openmetadata" icon="wind">
    Deploy, configure and manage the ingestion workflows using Apache Airflow as the orchestrator.
  </Card>
  <Card title="Kubernetes Orchestrator" href="/v2.0.x-SNAPSHOT/deployment/ingestion/kubernetes" icon="cube">
...
<CardGroup cols={1}>
<Card title="External Ingestion" href="/v2.0.x-SNAPSHOT/deployment/ingestion/external" >
