...
<Info>
**No breaking changes.** The sampling configuration schemas are unchanged between 1.13 and 2.0.
Dynamic sampling (`sampleConfigType: DYNAMIC`, the default) shipped in the 1.13 line.
</Info>
