...
<Tip>
Existing services are migrated automatically. Update Terraform, Ansible and scripted service creation,
plus any ingestion YAML that sets `token` at the top level.
</Tip>
...
The separate `great-expectations-1xx` extra is **removed**. 1.3 is the floor because Great
