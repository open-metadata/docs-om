...
<CardGroup cols={2}>
<Card title="Use Nginx" href="/v2.0.x-SNAPSHOT/deployment/security/enable-ssl/nginx" >
    Use Nginx to enable SSL. This is the simplest solution.
  </Card>
  <Card title="Use the OpenMetadata Server" href="/v2.0.x-SNAPSHOT/deployment/security/enable-ssl/openmetadata-server" >
