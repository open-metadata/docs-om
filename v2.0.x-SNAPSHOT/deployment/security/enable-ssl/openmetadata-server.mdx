...
If you would like a simple way to set up SSL, please refer to the guide using [Nginx](/v2.0.x-SNAPSHOT/deployment/security/enable-ssl/nginx).
...
`https://localhost:8585`. You'll get the following error page and there is no way to proceed.
