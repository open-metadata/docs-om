...
sidebarTitle: Setting up Oidc Provider
collate: false
---
...
```
Check the more information about environment variable [here](/v1.13.x-SNAPSHOT/deployment/security/configuration-parameters).
