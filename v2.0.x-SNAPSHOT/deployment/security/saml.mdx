...
- **UPDATE** the Private / Public keys used for the [JWT Tokens](/v1.13.x-SNAPSHOT/deployment/security/enable-jwt-tokens) in case it is enabled.
...
- Follow the guide here for JWT Configuration [Enable JWT Token](/v1.13.x-SNAPSHOT/deployment/security/enable-jwt-tokens).

<Tip>

Security requirements for your **production** environment:
- **UPDATE** the Private / Public keys used for the [JWT Tokens](/v1.13.x-SNAPSHOT/deployment/security/enable-jwt-tokens) the ones shipped with OM are for POC only.
...
<CardGroup cols={1}>
<Card title="AWS Saml" href="/v1.13.x-SNAPSHOT/deployment/security/saml/aws" >
    Configure AWS as IDP.
  </Card>
</CardGroup>

<CardGroup cols={1}>
<Card title="Azure Saml" href="/v1.13.x-SNAPSHOT/deployment/security/saml/azure" >
    Configure AWS as IDP.
  </Card>
</CardGroup>
