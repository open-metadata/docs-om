...
Moreover, see how we are not configuring any tests in the `processor`. You can do [that](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/configure#full-yaml-config-example),
