...
This page contains code examples for running each workflow type externally. For framework setup, configuration, and JWT token handling, see the [External Ingestion Overview](/v2.0.x-SNAPSHOT/deployment/ingestion/external).
...
<Tip>
You can find complete YAMLs in each connector [docs](/v2.0.x-SNAPSHOT/connectors) and find more information about the available
configurations.
</Tip>
</Step>
...
You can find more information about this workflow [here](/v2.0.x-SNAPSHOT/connectors/ingestion/lineage).
...
You can find more information about this workflow [here](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/profiler-workflow).
...
You can find more information about this workflow [here](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/configure).
...
Moreover, see how we are not configuring any tests in the `processor`. You can configure them in the [advanced YAML example](/v2.0.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/data-quality-as-code/advanced-usage#yaml-file-structure),
