...
<CardGroup cols={2}>
  <Card title="Kubernetes Orchestrator" href="/v2.0.x-SNAPSHOT/deployment/ingestion/kubernetes">
    Run ingestion pipelines as native Kubernetes Jobs
  </Card>
  <Card title="EKS Deployment Guide" href="/v2.0.x-SNAPSHOT/deployment/kubernetes/eks">
    Manual Helm-based deployment on Amazon EKS
  </Card>
  <Card title="Helm Values Reference" href="/v2.0.x-SNAPSHOT/deployment/kubernetes/values">
    Full reference for OpenMetadata Helm chart values
  </Card>
  <Card title="Secrets Manager" href="/v2.0.x-SNAPSHOT/deployment/secrets-manager">
