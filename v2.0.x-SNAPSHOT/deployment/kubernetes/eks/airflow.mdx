...
Create RDS and OpenSearch credentials as Kubernetes Secrets, as described [here](/v2.0.x-SNAPSHOT/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).
