...
This page covers the Airflow-based orchestrator setup for AKS. For the simpler recommended Kubernetes-native orchestrator, see [AKS Deployment: Prerequisites & Kubernetes Orchestrator](/v2.0.x-SNAPSHOT/deployment/kubernetes/aks).
