...
<Card title="Ldap Authentication" href="/v2.0.x-SNAPSHOT/deployment/security/ldap" >
  ...
  <Card title="Azure SSO" href="/v2.0.x-SNAPSHOT/deployment/security/azure" >
    Configure Azure SSO to access the UI and APIs
  </Card>
  <Card title="Custom OIDC SSO" href="/v2.0.x-SNAPSHOT/deployment/security/custom-oidc" >
  ...
  <Card title="Amazon Cognito SSO" href="/v2.0.x-SNAPSHOT/deployment/security/amazon-cognito-sso" >
    Configure Amazon Cognito SSO to access the UI and APIs
  </Card>
  <Card title="OneLogin SSO" href="/v2.0.x-SNAPSHOT/deployment/security/one-login" >
    Configure OneLogin SSO to access the UI and APIs
  </Card>
  <Card title="Keycloak SSO" href="/v2.0.x-SNAPSHOT/deployment/security/keycloak" >
