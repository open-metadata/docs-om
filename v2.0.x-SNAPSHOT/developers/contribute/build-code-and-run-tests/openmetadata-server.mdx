...
- You are now ready to explore the app at `http://localhost:8585`. If the web page does not work as intended, see the [troubleshooting steps](/v2.0.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/openmetadata-server#troubleshooting).
