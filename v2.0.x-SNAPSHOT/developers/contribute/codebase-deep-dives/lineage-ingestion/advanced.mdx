...
This page covers entity resolution, cross-database lineage, stored procedure and view lineage, parallel processing, publishing, dialect mapping, and configuration. For the pipeline overview, SQL parsing, and graph analysis, see [Lineage Ingestion](/v2.0.x-SNAPSHOT/developers/contribute/codebase-deep-dives/lineage-ingestion).
