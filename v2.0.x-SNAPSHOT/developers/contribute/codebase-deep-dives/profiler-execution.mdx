...
This page covers the execution internals and extension points. For the architecture overview and metrics system, see [Profiler Module | Architecture & Metrics System](/v2.0.x-SNAPSHOT/developers/contribute/codebase-deep-dives/profiler).
