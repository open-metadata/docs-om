...
<Info>
Both configurations automatically install all [prerequisites](/v2.0.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/prerequisites) — no manual dependency setup required.
</Info>
...
<CardGroup cols={2}>
  <Card title="Build Code and Run Tests" icon="hammer" href="/v2.0.x-SNAPSHOT/developers/contribute/build-code-and-run-tests">
    Learn how to build individual components and run the test suite.
  </Card>
  <Card title="Develop a New Connector" icon="plug" href="/v2.0.x-SNAPSHOT/developers/contribute/developing-a-new-connector">
