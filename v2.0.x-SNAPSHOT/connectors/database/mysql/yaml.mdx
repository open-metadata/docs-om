...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v2.0.x-SNAPSHOT/connectors/ingestion/workflows/lineage)
