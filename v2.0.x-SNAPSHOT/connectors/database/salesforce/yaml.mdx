...
<ContentSection id={4} title="Username / Password (Legacy)" lines="11-13">

**username**, **password**, **securityToken**: Legacy username/password authentication credentials. Uncomment these fields and remove `consumerKey`/`consumerSecret` if using this method.
