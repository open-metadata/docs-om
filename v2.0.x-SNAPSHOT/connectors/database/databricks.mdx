...
- [Troubleshooting](/v2.0.x-SNAPSHOT/connectors/database/databricks/troubleshooting)
...
If you are using Unity Catalog in Databricks, then checkout the [Unity Catalog](/v2.0.x-SNAPSHOT/connectors/database/unity-catalog) connector.
