...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v2.0.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v2.0.x-SNAPSHOT/connectors/database/bigquery/create-credentials">
