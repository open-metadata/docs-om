...
The default value, if not set, may assume the standard on-demand BigQuery pricing (for example, $5.00 per TiB), but you should adjust it according to your organization's negotiated rates or flat-rate pricing model.
