...
For details on creating glossary terms, refer to the [OpenMetadata documentation](/v2.0.x-SNAPSHOT/how-to-guides/data-governance/glossary/create-terms)
...
You can view the glossary term FQNs in the current URL: `https://localhost:8585/glossary/Test_Glossary.term_two.nested_term.more_nested_term`.
