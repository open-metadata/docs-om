...
See the [Storage Configuration Overview](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-configuration-overview) for setup guides:
- [AWS S3](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) | [Google Cloud Storage](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) | [Azure Blob](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) | [HTTP Server](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-http-guide) | [Local/Shared Filesystem](/v2.0.x-SNAPSHOT/connectors/database/dbt/storage-local-guide)
...
### Step 1: Add a dbt Ingestion

In the Service details page, navigate to the **Agents** tab and click **Add Agent** > **DBT**.

<img src="/public/images/connector2.0/dbt/add-dbt-agent.png" alt="add-ingestion" />

### Step 2: Configure the dbt Ingestion
...
Follow the link [here](/v2.0.x-SNAPSHOT/connectors/database/dbt/setup-multiple-dbt-projects) for instructions on setting up multiple dbt projects.
...
To know how to get the values for `Dbt Cloud Account Id`, `Dbt Cloud Project Id` and `Dbt Cloud Job Id` fields check [here](/v2.0.x-SNAPSHOT/connectors/database/dbt/run-dbt-workflow-externally).
