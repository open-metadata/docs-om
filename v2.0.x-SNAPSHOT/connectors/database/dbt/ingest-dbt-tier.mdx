...
slug: /connectors/database/dbt/ingest-dbt-tier
...
For details on adding or selecting tiers, refer to the [OpenMetadata documentation](/v1.13.x-SNAPSHOT/how-to-guides/data-governance/classification/tiers#what-are-tiers)
