...
For details on adding or selecting tiers, refer to the [OpenMetadata documentation](/v2.0.x-SNAPSHOT/how-to-guides/data-governance/classification/tiers#what-are-tiers)
