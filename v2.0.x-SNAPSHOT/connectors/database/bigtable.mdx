...
- [Troubleshooting](/v2.0.x-SNAPSHOT/connectors/database/bigtable/troubleshooting)
...
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v2.0.x-SNAPSHOT/connectors/database/bigtable/roles">
