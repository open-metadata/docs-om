...
For the required database privileges, see the [Requirements section of the Exasol connector documentation](/v2.0.x-SNAPSHOT/connectors/database/exasol#requirements).
