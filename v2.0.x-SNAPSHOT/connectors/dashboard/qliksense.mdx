...
- [Lineage](#lineage)
- [Troubleshooting](/v1.13.x-SNAPSHOT/connectors/dashboard/qliksense/troubleshooting)
## Requirements
<Card title="OpenMetadata 1.1.1 or later" href="/v1.13.x-SNAPSHOT/deployment" >
...
Refer to the guide on how to generate authentication certificates so that OpenMetadata can communicate with Qlik Sense [here](/v1.13.x-SNAPSHOT/connectors/dashboard/qliksense/certificates).
