...
Review the [tested Custom Drive connector](https://github.com/open-metadata/OpenMetadata/blob/main/ingestion/tests/integration/custom_connectors/custom_drive.py) for a complete implementation.
