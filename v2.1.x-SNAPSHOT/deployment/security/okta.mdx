...
- [Implicit Flow](/v2.1.x-SNAPSHOT/deployment/security/okta/implicit-flow) (Public)
- [Auth Code Flow](/v2.1.x-SNAPSHOT/deployment/security/okta/auth-code-flow) (Confidential)
