...
import ConfigureIngestion from '/snippets/v2.1.x-SNAPSHOT/deployment/configure-ingestion.mdx'
...
configuration. To know how to enable it, you can follow the documentation of [Enable JWT Tokens](/v2.1.x-SNAPSHOT/deployment/security/enable-jwt-tokens).
