...
<Info>
If you prefer to use Apache Airflow as the orchestrator for your EKS deployment, see the [Airflow on EKS](/v2.1.x-SNAPSHOT/deployment/kubernetes/eks/airflow) guide.
</Info>
