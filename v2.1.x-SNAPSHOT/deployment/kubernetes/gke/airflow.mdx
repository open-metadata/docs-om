...
Create CloudSQL and Elasticsearch credentials as Kubernetes Secrets, as described [here](/v2.1.x-SNAPSHOT/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).
...
Please validate:
- all the prerequisites mentioned in this [section](/v2.1.x-SNAPSHOT/deployment/kubernetes/gke#prerequisites)
