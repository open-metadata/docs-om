...
Please refer to the [architecture section](/v2.1.x-SNAPSHOT/developers/architecture) for more details.
...
Learn more about how to deploy and manage the ingestion workflows [here](/v2.1.x-SNAPSHOT/deployment/ingestion).
