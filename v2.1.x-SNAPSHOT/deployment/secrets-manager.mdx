...
- [AWS Secrets Manager](/v2.1.x-SNAPSHOT/deployment/secrets-manager/supported-implementations/aws-secrets-manager)
- [AWS Systems Manager Parameter Store](/v2.1.x-SNAPSHOT/deployment/secrets-manager/supported-implementations/aws-ssm-parameter-store)
