---
title: Airflow Troubleshooting & Advanced | OpenMetadata Ingestion
description: Validate your Airflow installation, configure Git Sync and SSL, and troubleshoot common ingestion pipeline deployment issues.
sidebarTitle: Troubleshooting & Advanced
collate: false
---

# Airflow Troubleshooting & Advanced

This page covers installation validation, Git Sync guidance, SSL configuration, and troubleshooting for Airflow-based ingestion pipelines. For setup and configuration, see the [OpenMetadata Ingestion Overview](/v2.1.x-SNAPSHOT/deployment/ingestion/openmetadata).
...
- If you have an existing Airflow instance, and you want to build and maintain your own ingestion DAGs then you can go for it. Check a DAG example [here](/v2.1.x-SNAPSHOT/deployment/ingestion/external/airflow#example).
...
<CardGroup cols={1}>
<Card title="Airflow SSL" href="/v2.1.x-SNAPSHOT/deployment/security/enable-ssl/airflow-ssl" >
...
We have specific instructions on how to set up the shared volumes in Kubernetes depending on your cloud deployment [here](/v2.1.x-SNAPSHOT/deployment/kubernetes).
...
OpenMetadata server 2.0.0 you will need to install `openmetadata-ingestion~=2.0.0.0`. Note that we are validating
