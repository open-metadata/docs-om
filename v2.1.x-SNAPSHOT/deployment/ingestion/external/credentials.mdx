...
For example, if you are using the [Glue](/v2.1.x-SNAPSHOT/connectors/database/glue) connector you could specify the
...
You can validate the whole Google service account setup [here](/v2.1.x-SNAPSHOT/deployment/security/google).
...
[Using Airflow Connections](/v2.1.x-SNAPSHOT/deployment/ingestion/external/credentials-airflow).
