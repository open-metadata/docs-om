...
It also requires the ingestion package to be at least `openmetadata-ingestion==2.0.2.0`.
...
with models.DAG(
    ...
    KubernetesPodOperator(
        ...
        name="ingest",
        cmds=["python", "main.py"],
        image="openmetadata/ingestion-base:2.0.2",
        namespace='default',
...
Note that the example uses the image `openmetadata/ingestion-base:2.0.2`. The image version should be aligned with
