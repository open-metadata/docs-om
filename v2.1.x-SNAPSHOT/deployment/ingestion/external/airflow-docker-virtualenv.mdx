...
- **Image Version**: Ensure the Docker image version matches your OpenMetadata server version (e.g., `openmetadata/ingestion-base:2.0.0`).
...
with DAG(
    ...
    ingest_task = PythonVirtualenvOperator(
        ...
        requirements=[
            'openmetadata-ingestion[mysql]~=2.0.0.0',  # Specify any additional Python package dependencies
        ],
