...
Replace `2.0.2` with your actual server version. The ingestion major version must match the server major version — for example, a 2.0.x server requires a 2.0.x ingestion image.
