...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/2.0.0-release/docker-compose-openmetadata.yml
```
...
[Docker Advanced Configuration & Troubleshooting](/v2.1.x-SNAPSHOT/deployment/docker/advanced).
