...
You can find more details about Docker deployment [here](/v2.1.x-SNAPSHOT/deployment/docker)
...
<Card title="Troubleshooting" href="/v2.1.x-SNAPSHOT/deployment/upgrade/docker-troubleshooting">
