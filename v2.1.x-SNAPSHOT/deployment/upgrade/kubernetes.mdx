...
import UpgradePrerequisites from '/snippets/v2.1.x-SNAPSHOT/deployment/upgrade/upgrade-prerequisites.mdx'
...
[Kubernetes Deployment](/v2.1.x-SNAPSHOT/deployment/kubernetes) guide.
...
You can learn more about how the migration process works [here](/v2.1.x-SNAPSHOT/deployment/upgrade/how-does-it-work).
...
[Kubernetes Upgrade Troubleshooting](/v2.1.x-SNAPSHOT/deployment/upgrade/kubernetes-troubleshooting).
