...
[Discovery & Search](/v2.1.x-SNAPSHOT/deployment/upgrade/breaking-changes/discovery-and-search).
...
to be enabled — see
[Platform & Security](/v2.1.x-SNAPSHOT/deployment/upgrade/breaking-changes/platform-and-security).
</Warning>
