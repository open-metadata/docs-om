...
1. Backup the Database using Metadata Backup CLI as mentioned [here](/v2.1.x-SNAPSHOT/deployment/backup-restore-metadata)
...
4. Install the latest version of [OpenMetadata Dependencies Helm Chart](/v2.1.x-SNAPSHOT/deployment/kubernetes)
5. Restore the Database using Metadata Restore CLI as mentioned [here](/v2.1.x-SNAPSHOT/deployment/backup-restore-metadata)
6. Next, Proceed with upgrade for OpenMetadata Helm Chart as mentioned [here](/v2.1.x-SNAPSHOT/deployment/upgrade/kubernetes#step-4-upgrade-openmetadata)
