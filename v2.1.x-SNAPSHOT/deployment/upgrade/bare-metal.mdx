...
[Bare Metal deployment](/v2.1.x-SNAPSHOT/deployment/bare-metal) guide.

<Info>
Ready to upgrade? Continue to the [Upgrade Steps](/v2.1.x-SNAPSHOT/deployment/upgrade/bare-metal/steps) for the step-by-step upgrade process and post-upgrade tasks.
</Info>
