...
Follow the steps below to upgrade your OpenMetadata bare-metal deployment. Before proceeding, make sure you have completed the [prerequisites](/v2.1.x-SNAPSHOT/deployment/upgrade/bare-metal).
