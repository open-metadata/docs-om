...
Semantic Search also powers the [Semantic Search MCP tool](/v2.1.x-SNAPSHOT/how-to-guides/mcp/semantic-search),
...
`searchIndex`, `topic`, `contextMemory`, `container`, `testSuite`, `testCase`, `query`, `llmModel`,
`aiApplication`, `promptTemplate`, `mcpServer`, `aiGovernancePolicy`, `aiGovernanceFramework`
