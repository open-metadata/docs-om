...
The main difference here is between those sources that provide internal access to query logs and those that do not. For services such as [BigQuery](/v2.1.x-SNAPSHOT/connectors/database/bigquery), [Snowflake](/v2.1.x-SNAPSHOT/connectors/database/snowflake) etc.
...
the [workflow](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/usage/usage-workflow-query-logs).
...
- [Exasol](https://github.com/open-metadata/OpenMetadata/blob/main/ingestion/src/metadata/ingestion/source/database/exasol/queries.py)
...
The supported services here are [Airflow](/v2.1.x-SNAPSHOT/connectors/pipeline/airflow),
[Fivetran](/v2.1.x-SNAPSHOT/connectors/pipeline/fivetran), [Dagster](/v2.1.x-SNAPSHOT/connectors/pipeline/dagster)
and [Airbyte](/v2.1.x-SNAPSHOT/connectors/pipeline/airbyte).
...
[here](/v2.1.x-SNAPSHOT/connectors/pipeline/airflow/lineage-backend#adding-lineage).
...
<CardGroup cols={1}>
<Card title="Manual Lineage" href="/v2.1.x-SNAPSHOT/connectors/ingestion/lineage/edit-lineage-manually" >
