...
3. Open the **Agents** tab, click **Add Agent**, and select **Add Lineage Agent**.

    <img src="/public/images/connector2.0/agents/add-lineage-agent.png" alt="Add Lineage Agent" />
