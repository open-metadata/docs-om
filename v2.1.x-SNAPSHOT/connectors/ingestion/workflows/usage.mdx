...
- [BigQuery](/v2.1.x-SNAPSHOT/connectors/database/bigquery)
- [Clickhouse](/v2.1.x-SNAPSHOT/connectors/database/clickhouse)
- [Databricks](/v2.1.x-SNAPSHOT/connectors/database/databricks)
- [Exasol](/v2.1.x-SNAPSHOT/connectors/database/exasol)
- [MSSQL](/v2.1.x-SNAPSHOT/connectors/database/mssql)
- [PostgreSQL](/v2.1.x-SNAPSHOT/connectors/database/postgres)
- [Redshift](/v2.1.x-SNAPSHOT/connectors/database/redshift)
- [Snowflake](/v2.1.x-SNAPSHOT/connectors/database/snowflake)
...
<CardGroup cols={1}>
<Card title="Usage Workflow through Query Logs" href="/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/usage/usage-workflow-query-logs" >
...
3. Open the **Agents** tab, click **Add Agent**, and select **Add Usage Agent**.

    <img src="/public/images/connector2.0/agents/add-usage-agent.png" alt="Add Usage Agent" />
...
In the [connectors](/v2.1.x-SNAPSHOT/connectors) section we showcase how to run the metadata ingestion from a JSON/YAML file using the Airflow SDK or the CLI via metadata ingest. Running a usage workflow is also possible using a JSON/YAML configuration file.
