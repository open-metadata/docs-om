...
can find that [here](/v2.1.x-SNAPSHOT/main-concepts/high-level-design).
...
Where the YAML config shape is defined in each [Connector](/v2.1.x-SNAPSHOT/connectors) and
