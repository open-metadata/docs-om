...
Login to the [Power BI](https://app.powerbi.com/) as Admin and enable the tenant settings below from [Tenant settings](https://app.powerbi.com/admin-portal/tenantSettings?experience=power-bi) in the Admin portal.
