...
Go to the `Azure Ad app registrations` page, select your app and add the permissions below to the app for PowerBI service and grant admin consent for the same.
...
Refer to the [Power BI Admin and Non-Admin APIs](/v2.1.x-SNAPSHOT/connectors/dashboard/powerbi#powerbi-admin-and-non-admin-apis) section for more information.
- Enabled (Use PowerBI Admin APIs)
- Disabled (Use Non-Admin PowerBI APIs)
</ContentSection>
