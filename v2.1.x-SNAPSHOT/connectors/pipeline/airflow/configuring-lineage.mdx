...
Regardless of the Airflow ingestion process you follow ([Workflow](/v2.1.x-SNAPSHOT/connectors/pipeline/airflow),
[Lineage Backend](/v2.1.x-SNAPSHOT/connectors/pipeline/airflow/lineage-backend) or [Lineage Operator](/v2.1.x-SNAPSHOT/connectors/pipeline/airflow/lineage-operator)),
...
This `OMEntity` class follows the model used by Airflow's
[lineage API](https://airflow.apache.org/docs/apache-airflow/stable/administration-and-deployment/lineage.html).
