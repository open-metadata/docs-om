...
<ContentSection id={2} title="Authentication Type" lines="8-18">
...
<ContentSection id={3} title="HTTP Path" lines="19">
**httpPath**: Databricks Pipeline compute resources URL.
</ContentSection>
<ContentSection id={4} title="Connection Arguments (Optional)" lines="20-21">
...
<ContentSection id={5} title="Source Config" lines="22-41">
<SourceConfigDef />
</ContentSection>
<IngestionSinkDef />
<WorkflowConfigDef />
