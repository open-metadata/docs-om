...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/redshift)
...
- [Troubleshooting](/v2.1.x-SNAPSHOT/connectors/database/redshift/troubleshooting)
...
```
More information on the profiler workflow setup can be found [here](/v2.1.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v2.1.x-SNAPSHOT/how-to-guides/data-quality-observability/quality).
### Usage & Lineage
...
You can find more information on the usage workflow [here](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/lineage).
### Stored Procedures
