...
source:
  ...
  serviceConnection:
    config:
      ...
      # queryStatementSource: pg_stat_statements  # Custom view/table for query history
      # connectionOptions:
      #   key: value
      # connectionArguments:
      #   key: value
