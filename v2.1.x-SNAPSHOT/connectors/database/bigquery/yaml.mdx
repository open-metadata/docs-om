...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v2.1.x-SNAPSHOT/connectors/database/bigquery/create-credentials">
...
<ContentSection id={3} title="Host and Port" lines="7">

**hostPort**: The ingestion runtime uses the BigQuery API endpoint `bigquery.googleapis.com`. Custom `hostPort` values are not currently applied.

</ContentSection>

<ContentSection id={4} title="Billing Project ID" lines="8">
...
<ContentSection id={5} title="Credentials" lines="9-10">
...
<ContentSection id={6} title="GCP Configuration" lines="10-23">
...
<ContentSection id={7} title="GCP Impersonate Service Account" lines="24-26">
...
<ContentSection id={8} title="Include Policy Tags" lines="27">

**includePolicyTags** (Optional): Option to include policy tags as part of the column description. Enabled by default.

</ContentSection>

<ContentSection id={9} title="Taxonomy Configuration" lines="28-29">
...
<ContentSection id={10} title="Usage Location" lines="30">
...
<ContentSection id={11} title="Cost Per TiB" lines="31">
...
This setting does **not** affect actual billing—it is only used for internal reporting and visualization of estimated costs. The default value is $6.25 per TiB; adjust it according to your organization's negotiated rates or flat-rate pricing model.

</ContentSection>

<ContentSection id={12} title="Connection Options" lines="32-33">

**Connection Options (Optional)**: Enter the details for any additional connection options that can be sent to database during the connection. These details must be added as Key-Value pairs.

</ContentSection>

<ContentSection id={13} title="Connection Arguments" lines="34-35">
...
<ContentSection id={14} title="Source Config" lines="36-79">

<SourceConfigDef />

</ContentSection>

<ContentSection id={15} title="Sink Configuration" lines="80-82">

<IngestionSinkDef />

</ContentSection>

<ContentSection id={16} title="Workflow Configuration" lines="83-99">
...
<DataQuality />
## dbt Integration
You can learn more about how to ingest dbt models' definitions and their lineage [here](/v2.1.x-SNAPSHOT/connectors/database/dbt).
