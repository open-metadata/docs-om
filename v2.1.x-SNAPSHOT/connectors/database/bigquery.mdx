...
- [Troubleshooting](/v2.1.x-SNAPSHOT/connectors/database/bigquery/troubleshooting)

## Requirements
You need to create an service account in order to ingest metadata from bigquery refer. For more information about how to create a service account, see [Create Custom GCP Role](/v2.1.x-SNAPSHOT/connectors/database/bigquery/create-credentials).
