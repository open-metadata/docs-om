...
- [Troubleshooting](/v2.1.x-SNAPSHOT/connectors/database/sap-erp/troubleshooting)
...
Follow the guide [here](/v2.1.x-SNAPSHOT/connectors/database/sap-erp/setup-sap-apis) to setup the APIs.
