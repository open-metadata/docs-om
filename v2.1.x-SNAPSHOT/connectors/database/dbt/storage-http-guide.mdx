...
description: Configure HTTP/HTTPS servers for dbt artifact storage with OpenMetadata. Includes Nginx, Apache, and S3+CloudFront examples.
...
**Setup:**
1. Follow [S3 guide](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) to create bucket and upload artifacts
...
3. Configure OpenMetadata with CloudFront URL:
...
- [Configure dbt Workflow](/v2.1.x-SNAPSHOT/connectors/database/dbt/configure-dbt-workflow)
- [dbt Troubleshooting](/v2.1.x-SNAPSHOT/connectors/database/dbt/dbt-troubleshooting)

<Note>
See other storage options: [S3](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) | [GCS](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) | [Azure](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) | [Local](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-local-guide) | [dbt Cloud](/v2.1.x-SNAPSHOT/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
