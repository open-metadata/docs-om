...
- [S3 Storage](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) for AWS
- [GCS Storage](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) for GCP
- [Azure Blob Storage](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) for Azure
...
<Note>
See other storage options: [S3](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) | [GCS](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) | [Azure](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) | [HTTP](/v2.1.x-SNAPSHOT/connectors/database/dbt/storage-http-guide) | [dbt Cloud](/v2.1.x-SNAPSHOT/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
