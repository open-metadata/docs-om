...
#### Add a User to OpenMetadata:

1. Navigate to **Settings** > **Team & User Management** > **Users**.

    <img src="/public/images/connector2.0/dbt/access-users.png" alt="click-users-page" />

2. Click **Add User**.

    <img src="/public/images/connector2.0/dbt/add-users.png" alt="click-add-user" />
