...
import DataProfiler from '/snippets/v2.1.x-SNAPSHOT/connectors/yaml/data-profiler.mdx'
...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v2.1.x-SNAPSHOT/connectors/ingestion/workflows/lineage)
...
**authType**: Choose from basic auth, IAM based auth, and Azure auth.
...
<ContentSection id={6} title="Host and Port" lines="21">

**Host and Port**: Enter the fully qualified hostname and port number for your MySQL deployment in the Host and Port field.

</ContentSection>

<ContentSection id={7} title="Database Schema" lines="22-23">
...
source:
  ...
  serviceConnection:
    config:
      ...
      # authType:
      #   azureConfig:  # Azure AD / Entra auth for Azure Database for MySQL
...
## dbt Integration
<Columns cols={2}>
<Card title="dbt Integration" href="/v2.1.x-SNAPSHOT/connectors/database/dbt">
