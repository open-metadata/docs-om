...
For the required database privileges, see the [Requirements section of the Exasol connector documentation](/v2.1.x-SNAPSHOT/connectors/database/exasol#requirements).
