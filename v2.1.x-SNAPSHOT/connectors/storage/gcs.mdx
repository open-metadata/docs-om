...
- [Troubleshooting](/v2.1.x-SNAPSHOT/connectors/storage/gcs/troubleshooting)
...
You can learn more about this [here](/v2.1.x-SNAPSHOT/connectors/storage). Keep reading for an example on the shape of the manifest file.
