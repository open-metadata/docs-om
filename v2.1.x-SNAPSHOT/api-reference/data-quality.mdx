...
<CardGroup cols={3}>
  <Card title="Test Definitions" icon="flask" href="/v2.1.x-SNAPSHOT/api-reference/data-quality/test-definitions">
    Define the logic of a data quality check -- what to validate and what parameters it accepts.
  </Card>

  <Card title="Test Suites" icon="layer-group" href="/v2.1.x-SNAPSHOT/api-reference/data-quality/test-suites">
    Group test cases into executable or logical collections for organized testing.
  </Card>

  <Card title="Test Cases" icon="vial" href="/v2.1.x-SNAPSHOT/api-reference/data-quality/test-cases">
