...
<Columns cols={3}>
<Card icon='/public/images/icons/python-sdk.svg' title="Python SDK" href="/v2.1.x-SNAPSHOT/api-reference/sdk/python">
  A high-level, type-safe Python API that smoothly integrates with the OpenMetadata backend.
</Card>
<Card icon='/public/images/icons/java-sdk.svg' title="Java SDK" href="/v2.1.x-SNAPSHOT/api-reference/sdk/java">
  Integrate OpenMetadata into your Java environment to provision and manage resources.
</Card>
<Card icon='/public/images/icons/go-sdk.svg' title="Golang SDK" href="/v2.1.x-SNAPSHOT/api-reference/sdk/go">
