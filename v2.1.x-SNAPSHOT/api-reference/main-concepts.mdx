...
<CardGroup>
  <Card title="High Level Design" href="/v2.1.x-SNAPSHOT/main-concepts/high-level-design">
...
<CardGroup cols={2}>
  <Card title="OpenMetadata Schemas" href="/v2.1.x-SNAPSHOT/main-concepts/metadata-standard">
    Review the standard that powers OpenMetadata with JSON Schema.
  </Card>
  <Card title="OpenMetadata APIs" href="/v2.1.x-SNAPSHOT/main-concepts/metadata-standard/apis">
