...
This is enforced at the instance level, including through bulk import, by the **Multiple Users or Single Team Ownership** rule in [Data Asset Rules](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/data-asset-rules). It's enabled by default; admins can disable it if more flexible ownership is needed.
...
<Card title="How to Follow a Data Asset" href="/v2.1.x-SNAPSHOT/how-to-guides/guide-for-data-users/follow-data-asset" >
