...
Data assets can also be classified using Tiers. Learn more about [Tiers](/v2.1.x-SNAPSHOT/how-to-guides/data-governance/classification/tiers).

Among the Classification Tags, OpenMetadata has some System Classification. Learn more about the [System Tags](/v2.1.x-SNAPSHOT/how-to-guides/data-governance/classification/classification#classification-in-openmetadata).
...
<Card title="How to Request for Tags" href="/v2.1.x-SNAPSHOT/how-to-guides/guide-for-data-users/request-tags" >
