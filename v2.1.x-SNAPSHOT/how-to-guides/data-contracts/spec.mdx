...
3. [Security](#security)
4. [Business Assertions (data quality)](#quality-assertions)
5. [SLA](#sla)
...
When you import an ODCS contract, its quality rules that OpenMetadata can run become test cases in this section. For more information, see [ODCS Import and Export](/v2.1.x-SNAPSHOT/how-to-guides/data-contracts/odcs).
...
schema:
  - name: customer_id
    ...
    description: New ID from OpenMetadata UI
