...
- [Building Blocks of Authorization – Rules, Policies, and Roles](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies/authorization) – how rules, policies, and roles work
- [Resource Scope and Operations Reference](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/roles-policies/resource-scope) – reference guide for resources and operations
