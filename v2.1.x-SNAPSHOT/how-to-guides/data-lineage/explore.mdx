...
Use the gear icon's **Lineage Config** to change how many Upstream and Downstream Nodes this view displays, as well as the Nodes per layer — there's no fixed maximum here. This only affects your current view: it resets to the platform default the next time you open a lineage graph.
...
To change the default for every session, see [Lineage](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/preferences/lineage).
...
<Card title="How Column-Level Lineage Works" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/column" >
