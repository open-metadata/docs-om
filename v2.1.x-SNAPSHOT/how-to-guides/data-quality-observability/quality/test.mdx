...
Users can also set up [alerts](/v2.1.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) to be notified when a test fails.
...
**Note**: Restoring a test case requires **EditAll** permission on test cases. You can also restore a deleted test case from its own details page, which stays read-only until it's restored.
 ...
 <Card title="How to Set Alerts for Test Case Fails" href="/v2.1.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts" >
