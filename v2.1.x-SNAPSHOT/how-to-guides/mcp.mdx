...
1. Go to `&lt;YOUR-OpenMetadata-SERVER&gt;/users/&lt;YOUR-USERNAME&gt;/access-token` and select **Generate New Token**. This will give your AI agent the same role and access policy that is assigned to you in OpenMetadata. If you would like it to have different role-based access controls, create a new user.
