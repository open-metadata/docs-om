...
<CardGroup cols={2}>
<Card title="Lineage Workflow" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/workflow" >
    Configure a lineage workflow right from the UI.
  </Card>
 <Card title="Explore Lineage" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/explore" >
    Explore the rich lineage view in OpenMetadata.
  </Card>
 <Card title="Column-Level Lineage" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/column" >
    Explore and edit the rich column-level lineage.
  </Card>
 <Card title="Manual Lineage" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/manual" >
    Edit the table and column level lineage manually.
  </Card>
 <Card title="Cross Database Lineage" href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage/cross-database-lineage" >
