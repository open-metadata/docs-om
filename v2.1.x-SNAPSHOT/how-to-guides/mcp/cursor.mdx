...
Follow the [Personal Access Token guide](/v2.1.x-SNAPSHOT/how-to-guides/mcp#personal-access-token-pat) to generate your token.
...
6. **Token expired (PAT method)**: [Generate a new PAT](/v2.1.x-SNAPSHOT/how-to-guides/guide-for-data-users/personal-access-token) and update your configuration
