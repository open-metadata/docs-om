...
## Quick Filters
Multiple quick filter options further help to narrow down the search by **Owner, Tag, Tier, Data Product, Service, Service Type**, and other filters relevant to the type of data asset like **Database, Schema, Columns**. You can also search by deleted data assets.

<img src="/public/images/how-to-guides/discovery/2.0/quick-filters.png" alt="Filter using Multiple Parameters" />
...
<Card title="Get a Quick Glance of the Data Assets" href="/v2.1.x-SNAPSHOT/how-to-guides/data-discovery/preview" >
