...
Most data catalogs can tell you *what* exists: this table has these columns, this dashboard reads that table. Far fewer can tell you *what it means*: that `cust_acct_bal_amt` is a **Customer Account Balance**, that a Customer Account Balance is calculated from **Transactions**, that Transactions are regulated by **AML**, and that anything regulated by AML must be retained for seven years.
