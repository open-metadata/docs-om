...
| `om:UPSTREAM` | OpenMetadata's own lineage predicate, written alongside `prov:wasDerivedFrom`. Uppercase, deliberately — this is the exact form stored in the graph. |
