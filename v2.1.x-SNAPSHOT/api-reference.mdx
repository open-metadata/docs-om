...
<Card title="Authentication Guide" icon="key" href="/v2.1.x-SNAPSHOT/api-reference/authentication">
...
<CardGroup cols={2}>
  <Card title="Data Assets" icon="database" href="/v2.1.x-SNAPSHOT/api-reference/data-assets">
    Manage tables, dashboards, pipelines, topics, ML models, and more.
  </Card>
  <Card title="Discovery" icon="magnifying-glass" href="/v2.1.x-SNAPSHOT/api-reference/discovery">
    Search and discover metadata across your catalog.
  </Card>
  <Card title="Data Contracts" icon="file-contract" href="/v2.1.x-SNAPSHOT/api-reference/data-contracts">
    Define and validate data contracts for your assets.
  </Card>
  <Card title="Teams & Users" icon="users" href="/v2.1.x-SNAPSHOT/api-reference/teams-and-users">
    Manage users, teams, and organizational structure.
  </Card>
  <Card title="Data Governance" icon="shield-check" href="/v2.1.x-SNAPSHOT/api-reference/governance">
    Manage domains, glossaries, classifications, and tags.
  </Card>
  <Card title="Data Quality" icon="chart-line" href="/v2.1.x-SNAPSHOT/api-reference/data-quality">
