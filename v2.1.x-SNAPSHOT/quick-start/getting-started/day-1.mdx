...
Once you have logged into your OpenMetadata instance, set up a data connector to start ingesting metadata. OpenMetadata provides [90+ turnkey connectors](/v2.1.x-SNAPSHOT/connectors) for a wide range of services, including:
...
For [custom data sources](/v2.1.x-SNAPSHOT/connectors/custom-connectors), metadata ingestion can also be set up via API.
...
<Columns cols={2}>
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/quick-start/getting-started/day-1/database-service-setup"
    horizontal
  >
...
Once the connector is set up, configure a [metadata ingestion pipeline](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/how-to-ingest-metadata) 
...
<img src="/public/images/getting-started/add-ingestion.png" alt="Add Metadata Agent" />
...
After metadata has been ingested into OpenMetadata, you can [invite users](/v2.1.x-SNAPSHOT/how-to-guides/admin-guide/teams-and-users/invite-users) to collaborate on the data and assign different roles.
...
<Columns cols={2}>
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-discovery"
    horizontal
  >
  ...
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-collaboration"
    horizontal
  >
  ...
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-quality-observability"
    horizontal
  >
  ...
  <Card
    ...
    title="Data Lineage"
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-lineage"
    horizontal
  >
  ...
  <Card
    ...
    title="Data Insights"
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-insights"
    horizontal
  >
  ...
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/how-to-guides/data-governance"
    horizontal
  >
...
<Columns cols={2}>
  <Card
    ...
    title="Admin Guide"
    href="/v2.1.x-SNAPSHOT/how-to-guides/admin-guide"
    horizontal
  >
  ...
  <Card
    ...
    href="/v2.1.x-SNAPSHOT/how-to-guides/guide-for-data-users"
    horizontal
  >
