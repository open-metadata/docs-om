...
<Info>
Both configurations automatically install all [prerequisites](/v2.1.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/prerequisites) — no manual dependency setup required.
</Info>
...
<Steps>
  <Step title="Install the Dev Containers extension">
    Install the Dev Containers extension by following the [VS Code Dev Containers instructions](https://code.visualstudio.com/docs/devcontainers/containers).
  </Step>
...
<CardGroup cols={2}>
  <Card title="Build Code and Run Tests" icon="hammer" href="/v2.1.x-SNAPSHOT/developers/contribute/build-code-and-run-tests">
    Learn how to build individual components and run the test suite.
  </Card>
  <Card title="Develop a New Connector" icon="plug" href="/v2.1.x-SNAPSHOT/developers/contribute/developing-a-new-connector">
