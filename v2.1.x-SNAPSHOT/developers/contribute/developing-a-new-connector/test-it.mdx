...
The easiest way to do is to check how to do it [here](/v2.1.x-SNAPSHOT/developers/contribute/build-code-and-run-tests).
...
<Card title="Update the Documentation" href="/v2.1.x-SNAPSHOT/developers/contribute/developing-a-new-connector/update-documentation" >
