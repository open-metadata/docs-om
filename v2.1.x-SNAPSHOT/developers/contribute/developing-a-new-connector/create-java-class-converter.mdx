...
If you remember from [Define the JSON Schema](/v2.1.x-SNAPSHOT/developers/contribute/developing-a-new-connector/define-json-schema), the MysqlConnection uses `oneOf` to define the `authType` property:
...
<Card title="Test It" href="/v2.1.x-SNAPSHOT/developers/contribute/developing-a-new-connector/test-it" >
