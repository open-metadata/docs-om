...
sidebarTitle: Connector Troubleshoot
---
...
Please, ensure you have a Bucket Policy with the permissions explained in the requirement section [here](/v1.12.x-SNAPSHOT/connectors/database/s3-datalake).
