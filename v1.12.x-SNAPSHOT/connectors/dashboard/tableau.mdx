...
name="Tableau"
stage="PROD"
availableFeatures={["Dashboards", "Charts", "Lineage", "Owners", "Datamodels", "Tags", "Projects", "Column Lineage", "Usage", "Reverse Metadata (OpenMetadata Only)"]}
unavailableFeatures={[]} />
...
- [Lineage](#lineage)
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/dashboard/tableau/troubleshooting)
