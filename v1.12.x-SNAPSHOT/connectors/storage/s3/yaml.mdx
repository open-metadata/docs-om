...
## Requirements
<Card title="OpenMetadata 1.0 or later" href="/v1.12.x-SNAPSHOT/deployment" >
...
You can learn more about this [here](/v1.12.x-SNAPSHOT/connectors/storage). Keep reading for an example on the shape of the manifest file.
<Manifest />
## Metadata Ingestion
