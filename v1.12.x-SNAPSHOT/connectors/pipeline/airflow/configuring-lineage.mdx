...
Regardless of the Airflow ingestion process you follow ([Workflow](/v1.12.x-SNAPSHOT/connectors/pipeline/airflow),
[Lineage Backend](/v1.12.x-SNAPSHOT/connectors/pipeline/airflow/lineage-backend) or [Lineage Operator](/v1.12.x-SNAPSHOT/connectors/pipeline/airflow/lineage-operator)),
