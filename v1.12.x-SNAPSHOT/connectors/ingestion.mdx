...
<CardGroup cols={2}>
<Card title="Metadata Ingestion" href="/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/metadata" >
    Learn more about how to ingest metadata from dozens of connectors.
  </Card>

<Card title="Metadata Profiler" href="/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/external-workflow" >
    To get metrics from your Tables=
  </Card>

<Card title="Metadata Data Quality Tests" href="/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality" >
    To run automated Quality Tests on your Tables.
  </Card>

<Card title="Metadata Usage" href="/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/usage" >
    To analyze popular entities.
  </Card>

<Card title="Metadata Lineage" href="/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/lineage" >
...
<Card title="Great Expectations" href="/v1.12.x-SNAPSHOT/connectors/ingestion/great-expectations" >
...
<CardGroup cols={1}>
<Card title="Metadata Versioning" href="/v1.12.x-SNAPSHOT/connectors/ingestion/versioning" >
...
<CardGroup cols={1}>
<Card title="Best Practices" href="/v1.12.x-SNAPSHOT/connectors/ingestion/best-practices" >
...
<CardGroup cols={1}>
<Card title="Ingestion Pipeline UI Deployment" href="/v1.12.x-SNAPSHOT/connectors/ingestion/deployment" >
