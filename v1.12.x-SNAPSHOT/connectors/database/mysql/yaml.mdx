...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/lineage)
