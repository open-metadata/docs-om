...
name="Athena"
stage="PROD"
availableFeatures={["Metadata", "Query Usage", "Lineage", "Column-level Lineage", "Data Profiler", "Auto-Classification", "Data Quality", "Tags", "dbt", "Sample Data", "Reverse Metadata (OpenMetadata Only)"]}
...
You can find further information on the Athena connector in the [docs](/v1.12.x-SNAPSHOT/connectors/database/athena).
### Python Requirements
<PythonRequirements />
