...
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/bigtable/troubleshooting)
...
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v1.12.x-SNAPSHOT/connectors/database/bigtable/roles">
