...
name="BigQuery"
stage="PROD"
availableFeatures={["Metadata", "Query Usage", "Lineage", "Column-level Lineage", "Data Profiler", "Data Quality", "dbt", "Tags", "Stored Procedures", "Sample Data", "Reverse Metadata (OpenMetadata Only)", "Auto-Classification"]}
...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
- [Data Quality](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/configure)
- [Lineage](/v1.12.x-SNAPSHOT/connectors/ingestion/lineage)
- [dbt Integration](/v1.12.x-SNAPSHOT/connectors/database/dbt)
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/bigquery/troubleshooting)

<ExternalIngestionDeployment />
## Requirements
You need to create an service account in order to ingest metadata from bigquery refer [this](/v1.12.x-SNAPSHOT/connectors/database/bigquery/create-credentials) guide on how to create service account.
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v1.12.x-SNAPSHOT/connectors/database/bigquery/create-credentials">
