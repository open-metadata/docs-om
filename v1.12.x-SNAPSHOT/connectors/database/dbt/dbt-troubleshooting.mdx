...
slug: /connectors/database/dbt/dbt-troubleshooting
...
- Follow to docs [here](/v1.12.x-SNAPSHOT/connectors/database/dbt/ingest-dbt-lineage) to see if necessary details are present in the manifest.json file.
