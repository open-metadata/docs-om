...
2. **Configure additional dbt features** like [tags](/v1.12.x-SNAPSHOT/connectors/database/dbt/ingest-dbt-tags), [tiers](/v1.12.x-SNAPSHOT/connectors/database/dbt/ingest-dbt-tier), and [glossary](/v1.12.x-SNAPSHOT/connectors/database/dbt/ingest-dbt-glossary)
3. **Set up data governance** policies and workflows
4. **Schedule regular ingestion** for keeping metadata up-to-date

For additional troubleshooting, refer to the [dbt Troubleshooting Guide](/v1.12.x-SNAPSHOT/connectors/database/dbt/dbt-troubleshooting).