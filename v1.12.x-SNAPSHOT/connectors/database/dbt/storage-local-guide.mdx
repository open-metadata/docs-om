---
title: dbt Artifact Storage - Local Filesystem Configuration | Collate
description: Configure local or shared filesystem for dbt artifact storage with Collate. Includes Docker Compose and Kubernetes PVC examples.
...
- [S3 Storage](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) for AWS
- [GCS Storage](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) for GCP
- [Azure Blob Storage](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) for Azure

## Next Steps

- [Configure dbt Workflow](/v1.12.x-SNAPSHOT/connectors/database/dbt/configure-dbt-workflow)
- [dbt Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/dbt/dbt-troubleshooting)

<Note>
See other storage options: [S3](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-s3-guide) | [GCS](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-gcs-guide) | [Azure](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-azure-guide) | [HTTP](/v1.12.x-SNAPSHOT/connectors/database/dbt/storage-http-guide) | [dbt Cloud](/v1.12.x-SNAPSHOT/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
