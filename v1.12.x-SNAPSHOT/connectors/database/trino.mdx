...
name="Trino"
stage="PROD"
availableFeatures={["Metadata", "Query Usage", "Data Profiler", "Data Quality", "Lineage", "Column-level Lineage", "dbt", "Sample Data", "Auto-Classification", "Reverse Metadata (OpenMetadata Only)"]}
...
- [Lineage](/v1.12.x-SNAPSHOT/how-to-guides/data-lineage/workflow)
...
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/trino/troubleshooting)
