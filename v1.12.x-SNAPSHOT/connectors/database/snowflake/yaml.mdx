...
name="Snowflake"
stage="PROD"
availableFeatures={["Metadata", "Query Usage", "Data Profiler", "Data Quality", "Lineage", "Column-level Lineage", "dbt", "Stored Procedures", "Tags", "Sample Data", "Reverse Metadata (OpenMetadata Only)", "Auto-Classification"]}
unavailableFeatures={[]} />
...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.12.x-SNAPSHOT/connectors/ingestion/workflows/metadata/incremental-extraction/snowflake)
