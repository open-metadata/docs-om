...
name="PostgreSQL"
stage="PROD"
availableFeatures={["Metadata", "Query Usage", "Data Profiler", "Data Quality", "dbt", "Lineage", "Column-level Lineage", "Owners", "Tags", "Stored Procedures", "Sample Data", "Reverse Metadata (OpenMetadata Only)", "Auto-Classification"]}
...
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/postgres/troubleshooting)
