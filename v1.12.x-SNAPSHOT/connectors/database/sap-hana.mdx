...
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/sap-hana/troubleshooting)
## Requirements
<Tip>
...
Executing the profiler Workflow or data quality tests, will require the user to have `SELECT` permission on the tables/schemas where the profiler/tests will be executed. The user should also be allowed to view information in `tables` for all objects in the database. More information on the profiler workflow setup can be found [here](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality).
## Metadata Ingestion
