...
<Info>
**Apache Iceberg Tables Supported**
Databricks natively supports Apache Iceberg tables. When you use the Databricks connector in OpenMetadata, Iceberg tables are automatically ingested with full support for metadata extraction, data profiling, and data quality workflows — no separate Iceberg connector required.
</Info>
