...
- [Troubleshooting](/v1.12.x-SNAPSHOT/connectors/database/databricks/troubleshooting)
...
## Unity Catalog
If you are using Unity Catalog in Databricks, then checkout the [Unity Catalog](/v1.12.x-SNAPSHOT/connectors/database/unity-catalog) connector.
## Metadata Ingestion
