...
can find that [here](/v1.12.x-SNAPSHOT/main-concepts/high-level-design).
...
Where the YAML config shape is defined in each [Connector](/v1.12.x-SNAPSHOT/connectors) and
