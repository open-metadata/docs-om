...
|--------|----------|-------------|
| `POST` | `/v1/dataQuality/testDefinitions` | [Create a custom test definition](/v1.12.x-SNAPSHOT/api-reference/data-quality/test-definitions/create) |
| `GET` | `/v1/dataQuality/testDefinitions` | [List test definitions](/v1.12.x-SNAPSHOT/api-reference/data-quality/test-definitions/list) |
| `GET` | `/v1/dataQuality/testDefinitions/{id}` | [Get by ID](/v1.12.x-SNAPSHOT/api-reference/data-quality/test-definitions/retrieve) |
| `GET` | `/v1/dataQuality/testDefinitions/name/{name}` | [Get by name](/v1.12.x-SNAPSHOT/api-reference/data-quality/test-definitions/retrieve) |
