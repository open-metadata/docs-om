...
description: Configure a database service connection in OpenMetadata and prepare it for metadata ingestion.
...
- The side panel offers guidance with available documentation, and you can also refer to the specific `Snowflake` Connector [documentation](/v1.12.x-SNAPSHOT/connectors)for more information.
