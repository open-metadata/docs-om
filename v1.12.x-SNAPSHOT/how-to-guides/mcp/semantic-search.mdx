...
- Ensure entities have been embedded by running the `reembed` CLI command. See the
  [deployment guide](/v1.12.x-SNAPSHOT/deployment/semantic-search#re-embedding-existing-entities) for details.
