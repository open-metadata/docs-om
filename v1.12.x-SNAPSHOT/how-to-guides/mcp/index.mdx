...
<CardGroup cols={2}>
<Card title="Collate MCP Server Connection Guide" href="/v1.12.x/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="Collate MCP Tools Reference" href="/v1.12.x/how-to-guides/mcp/reference" >
