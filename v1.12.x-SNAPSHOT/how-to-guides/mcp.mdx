...
MCP Clients like Claude and Goose will need a OpenMetadata Personal Access Client (PAT) to authenticate with the OpenMetadata MCP Server.

- Go to `&lt;YOUR-OpenMetadata-SERVER&gt;/users/&lt;YOUR-USERNAME&gt;/access-token` and select *Generate New Token*. This will give your AI agent the same role and access policy that is assign to you in OpenMetadata, if you would like it to have different role-based access controls, create a new user.
...
With MCP installed and a Personal Access Token created, you can connect OpenMetadata MCP Server to an MCP Client like Claude, Goose, or an API service. Choose your MCP Client below to start prompting with OpenMetadata!

<CardGroup cols={2}>
<Card title="OpenMetadata MCP Server Connection Guide" href="/v1.12.x-SNAPSHOT/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="OpenMetadata MCP Tools Reference" href="/v1.12.x-SNAPSHOT/how-to-guides/mcp/reference" >
    Detailed examples and usage patterns for all available OpenMetadata MCP tools.
  </Card>
 <Card title="Getting Started with Claude Desktop" href="/v1.12.x-SNAPSHOT/how-to-guides/mcp/claude" >
    Connect your OpenMetadata to Anthropic's popular AI assistant.
  </Card>
 <Card title="Getting Started with Goose" href="/v1.12.x-SNAPSHOT/how-to-guides/mcp/goose" >
    Connect your OpenMetadata to Block's Open-Source AI assistant.
  </Card>
 <Card title="Semantic Search Tool" href="/v1.12.x-SNAPSHOT/how-to-guides/mcp/semantic-search" >
