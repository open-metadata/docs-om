...
Data assets can also be classified using Tiers. Learn more about [Tiers](/v1.12.x-SNAPSHOT/how-to-guides/data-governance/classification/tiers).

Among the Classification Tags, OpenMetadata has some System Classification. Learn more about the [System Tags](/v1.12.x-SNAPSHOT/how-to-guides/data-governance/classification/classification#classification-in-openmetadata).
...
<Card title="How to Request for Tags" href="/v1.12.x-SNAPSHOT/how-to-guides/guide-for-data-users/request-tags" >
