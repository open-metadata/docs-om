...
OpenMetadata’s Browser Extension bridges the gap between users and metadata. Visit the Chrome webstore and search for OpenMetadata to add the extension to your Chrome browser with just a few clicks. You can find the Chrome browser extension [here](https://chromewebstore.google.com/detail/openmetadata/ndjnpiadedlmgddlpeklbnobebkpkdgb)
...
\
For more information on how to add URL to SSO redirect list, you can visit this [page](/v1.12.x-SNAPSHOT/deployment/security).
