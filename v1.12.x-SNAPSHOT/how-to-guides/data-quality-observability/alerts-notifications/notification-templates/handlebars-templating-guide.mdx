...
Helpers are functions that perform operations on your data. OpenMetadata provides 22 custom helpers beyond standard Handlebars features.
...
- `baseUrl` - Base URL of your OpenMetadata instance

For detailed information about available properties, see [Template Context Reference](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference).
...
This creates a link that opens the entity in OpenMetadata UI.
...
- **Explore OpenMetadata's helpers** → [Custom Helpers Reference](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/custom-helpers-reference)
- **Learn available data** → [Template Context Reference](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)