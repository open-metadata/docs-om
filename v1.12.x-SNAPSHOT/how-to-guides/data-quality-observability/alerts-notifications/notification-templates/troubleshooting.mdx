...
1. **Verify property names**
   - Check [Template Context Reference](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/template-context-reference)
...
2. **Verify `baseUrl` is set**
   ...
   - Check if your OpenMetadata URL is configured correctly
...
**Solution:**
- Check [Custom Helpers Reference](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/custom-helpers-reference)
