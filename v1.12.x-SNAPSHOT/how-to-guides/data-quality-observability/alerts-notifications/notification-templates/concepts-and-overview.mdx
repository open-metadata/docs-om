...
When an event occurs in OpenMetadata (e.g., a table is updated, a test case fails), the notification system follows this process:
...
OpenMetadata provides two types of notification templates to meet different needs:

### System Templates

Pre-built templates provided by OpenMetadata for common notification scenarios.
...
System templates are maintained by OpenMetadata and improve over time. If you haven't customized a system template, it will automatically update to newer versions when OpenMetadata releases improvements.
...
- Automatically adapted by OpenMetadata for each channel
...
OpenMetadata intelligently transforms this HTML for each channel:
...
- **New to templates?** → Start with [Create and Manage Templates](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/create-and-manage-templates)
- **Want to write templates?** → Learn [Handlebars Templating Guide](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
