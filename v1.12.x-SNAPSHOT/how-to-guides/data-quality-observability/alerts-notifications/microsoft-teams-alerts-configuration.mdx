...
sidebarTitle: Microsoft Teams Alerts Configuration
---
...
**If you are using OpenMetadata v1.12.0 or later:**
...
2. Select the type of alert you want to configure:
   - [**Data Observability Alerts**](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) (for data quality and pipeline monitoring)
   - [**System & Governance Notifications**](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/system-governance-notifications) (for metadata and governance events)
