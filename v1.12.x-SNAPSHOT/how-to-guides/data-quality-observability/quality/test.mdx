...
10. Table Data to Be Fresh: Validate the freshness of a table's data (OpenMetadata).
...
Users can also set up [alerts](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) to be notified when a test fails.

 <Card title="How to Set Alerts for Test Case Fails" href="/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts" >
