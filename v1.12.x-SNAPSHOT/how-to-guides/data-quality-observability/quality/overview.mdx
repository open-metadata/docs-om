...
The SaaS version of OpenMetadata offers an overview of the data quality test results grouped by dimensions. This gives users a quick insight about data quality performance centered around meaningful categories.
...
For a full list of test cases and their dimensions click [here](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/tests-yaml)
