...
<CardGroup cols={2}>
<Card title="Glossary Term" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/glossary-term" >
    Learn about the hierarchically arranged glossary terms.
  </Card>
 <Card title="Setup a Glossary" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/setup" >
    Learn how to set up a glossary manually in OpenMetadata.
  </Card>
 <Card title="Create Glossary Terms" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/create-terms" >
    Setup glossary terms to define the terminology. Add tags, synonyms, related terms, links, etc.
  </Card>
 <Card title="Bulk Import a Glossary" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/import" >
    Save time and effort by bulk uploading glossary terms using a CSV file.
  </Card>
 <Card title="Glossary Export" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/export" >
    Quickly export a glossary as a CSV file.
  </Card>
 <Card title="Glossary Approval Workflow" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/approval" >
    Set up a review and approval process for glossary terms.
  </Card>
  <Card title="Glossary Styling" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/styling" >
    Stylize your glossary terms with color-coding and icons.
  </Card>
 <Card title="Add Assets to Glossary Terms" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/assets" >
    Associate glossary terms to data assets making it easier for data discovery
  </Card>
 <Card title="Best Practices for Glossary" href="/v1.12.x-SNAPSHOT/how-to-guides/data-governance/glossary/best-practices" >
