...
Network Policies and Ingresses are optional manifests and disabled by default. These can be installed / enabled using the [Helm Values](/v1.12.x-SNAPSHOT/deployment/kubernetes/on-prem).

## Links

<CardGroup cols={2}>
<Card title="Helm Values" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/values" >
    For customizing OpenMetadata Helm Deployments
  </Card>
  <Card title="K8s Native Orchestrator" href="/v1.12.x-SNAPSHOT/deployment/ingestion/kubernetes" >
    Run ingestion pipelines as native K8s Jobs (no Airflow required)
  </Card>
  <Card title="Deploy in AWS EKS" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/eks" >
    Deploy OpenMetadata in AWS Kubernetes
  </Card>
  <Card title="Deploy in GCP GKE" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/gke" >
    Deploy OpenMetadata in GCP Kubernetes
  </Card>
  <Card title="Deploy in Azure AKS" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/aks" >
    Deploy OpenMetadata in Azure Kubernetes
  </Card>
  <Card title="Deploy in OnPremises Kubernetes" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/on-prem" >
