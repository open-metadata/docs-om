...
Please refer to the [architecture section](/v1.12.x-SNAPSHOT/developers/architecture) for more details.
...
Learn more about how to deploy and manage the ingestion workflows [here](/v1.12.x-SNAPSHOT/deployment/ingestion).
