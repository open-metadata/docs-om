...
<CardGroup cols={2}>
  <Card title="Docker Compose" icon="/public/images/icons/deploymentTile.svg" href="/v1.12.x-SNAPSHOT/deployment/docker">
    Single-node deployment for development and small teams
  </Card>
  <Card title="Kubernetes" icon="/public/images/icons/deploymentTile.svg" href="/v1.12.x-SNAPSHOT/deployment/kubernetes">
    Scalable deployment for production environments
  </Card>
  <Card title="AWS" icon="/public/images/icons/cloud.svg" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/eks">
    Managed deployment on Amazon Web Services
  </Card>
  <Card title="GCP" icon="/public/images/icons/cloud.svg" href="/v1.12.x-SNAPSHOT/deployment/kubernetes/gke">
