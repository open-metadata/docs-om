...
Make sure to create RDS and OpenSearch credentials as Kubernetes Secrets mentioned [here](/v1.12.x-SNAPSHOT/quick-start/local-kubernetes-deployment#2.-create-kubernetes-secrets-required-for-helm-charts).
