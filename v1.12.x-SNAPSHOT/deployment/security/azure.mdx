...
- [Implicit Flow](/v1.12.x-SNAPSHOT/deployment/security/azure/implicit-flow) (Public)
- [Auth Code Flow](/v1.12.x-SNAPSHOT/deployment/security/azure/auth-code-flow) (Confidential)
