...
<CardGroup cols={2}>
<Card title="Use Nginx" href="/v1.12.x-SNAPSHOT/deployment/security/enable-ssl/nginx" >
    Use Nginx to enable SSL. This is the simplest solution.
  </Card>
  <Card title="Use the OpenMetadata Server" href="/v1.12.x-SNAPSHOT/deployment/security/enable-ssl/openmetadata-server" >
