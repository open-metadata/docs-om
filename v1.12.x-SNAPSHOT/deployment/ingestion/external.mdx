...
<Tip>
You will find examples of all the workflow's YAML files at each Connector [page](/v1.12.x-SNAPSHOT/connectors).
</Tip>
...
To enable JWT Tokens, you will get more details [here](/v1.12.x-SNAPSHOT/deployment/security/enable-jwt-tokens).

You can refer to the JWT Troubleshooting section [link](/v1.12.x-SNAPSHOT/deployment/security/jwt-troubleshooting) for any issues in
...
or externally, if you have configured any [Secrets Manager](/v1.12.x-SNAPSHOT/deployment/secrets-manager).
...
If you have configured any [Secrets Manager](/v1.12.x-SNAPSHOT/deployment/secrets-manager), you need to let the Ingestion Framework know
how to retrieve the credentials securely.

Follow the [docs](/v1.12.x-SNAPSHOT/deployment/secrets-manager) to configure the secret retrieval based on your environment.

**SSL Configuration**

If you have added SSL to the [OpenMetadata server](/v1.12.x-SNAPSHOT/deployment/security/enable-ssl), then you will need to handle
...
Find more information on how to troubleshoot SSL issues [here](/v1.12.x-SNAPSHOT/deployment/security/enable-ssl/ssl-troubleshooting).
...
If you are using the [Secrets Manager](/v1.12.x-SNAPSHOT/deployment/secrets-manager), you can let the Ingestion client to pick up
...
<CardGroup cols={2}>
<Card title="Airflow" href="/v1.12.x-SNAPSHOT/deployment/ingestion/external/airflow" >
    Run the ingestion process externally from Airflow
  </Card>
  <Card title="MWAA" href="/v1.12.x-SNAPSHOT/deployment/ingestion/external/mwaa" >
    Run the ingestion process externally using AWS MWAA
  </Card>
  <Card title="GCP Composer " href="/v1.12.x-SNAPSHOT/deployment/ingestion/external/gcp-composer" >
    Run the ingestion process externally from GCP Composer
  </Card>
  <Card title="GitHub Actions" href="/v1.12.x-SNAPSHOT/deployment/ingestion/external/github-actions" >
...
<Tip>
You can find complete YAMLs in each connector [docs](/v1.12.x-SNAPSHOT/connectors) and find more information about the available
configurations.
</Tip>
</Step>
...
You can find more information about this workflow [here](/v1.12.x-SNAPSHOT/connectors/ingestion/lineage).
...
You can find more information about this workflow [here](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/profiler/profiler-workflow).
...
You can find more information about this workflow [here](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/configure).
...
Moreover, see how we are not configuring any tests in the `processor`. You can do [that](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/quality/configure#full-yaml-config-example),
