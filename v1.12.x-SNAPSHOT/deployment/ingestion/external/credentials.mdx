...
For example, if you are using the [Glue](/v1.12.x-SNAPSHOT/connectors/database/glue) connector you could specify the
...
You can validate the whole Google service account setup [here](/v1.12.x-SNAPSHOT/deployment/security/google).
...
(e.g., [Athena](/v1.12.x-SNAPSHOT/connectors/database/athena/yaml)).
