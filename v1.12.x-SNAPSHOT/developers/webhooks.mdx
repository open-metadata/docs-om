...
In 0.13.1 , webhooks have been deprecated. You should instead use [OpenMetadata alerts](/v1.12.x-SNAPSHOT/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts)
