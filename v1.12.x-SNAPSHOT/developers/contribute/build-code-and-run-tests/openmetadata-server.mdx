...
**Note** To understand more about openmetadata-ops.sh file click [here](/v1.12.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/openmetadata-ops)
...
- You are now ready to explore the app by going to [http://localhost:8585](http://localhost:8585) *If the web page doesn't work as intended, please take a look at the troubleshooting steps [here](/v1.12.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/openmetadata-server#troubleshooting)
...
- If you see blank page at [http://localhost:8585](http://localhost:8585), please check the logs at logs/openmetadata.log. You might be encountering one of the following errors:
  ...
  - Browser console shows javascript errors, try doing a [clean build](/v1.12.x-SNAPSHOT/developers/contribute/build-code-and-run-tests/openmetadata-server#create-a-distribution-packaging). Some npm packages may not have been built properly.
