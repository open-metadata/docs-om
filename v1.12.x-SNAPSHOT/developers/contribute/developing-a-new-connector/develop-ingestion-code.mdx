...
<Card title="OpenMetadata 1.6.0 or later" href="/v1.12.x-SNAPSHOT/deployment" >
...
<Card title="Apply the UI Changes" href="/v1.12.x-SNAPSHOT/developers/contribute/developing-a-new-connector/apply-ui-changes" >
