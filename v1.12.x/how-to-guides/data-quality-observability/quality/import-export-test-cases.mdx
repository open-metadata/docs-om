...
<Info>
**Note**: Test case CSV files don't have an **owner** column, unlike some other entity CSVs. In Bulk Edit, the **name**, **testDefinition**, **entityFQN**, and **testSuite** columns are locked, since they identify the test case and what it runs against.
</Info>
