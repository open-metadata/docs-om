...
Active users are users with at least one session. This report allows you to understand the platform usage and see how your organization leverages OpenMetadata.
