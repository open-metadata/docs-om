...
<CardGroup cols={3}>
<Card title="Understanding the Basics of OpenMetadata" href="/v1.12.x/how-to-guides/guide-for-data-users/basics-openmetadata" >
    Learn about the OpenMetadata landing page and widgets
  </Card>
 <Card title="Overview of Data Assets" href="/v1.12.x/how-to-guides/guide-for-data-users/data-asset-tabs" >
    Learn about the data assets and the details associated with it.
  </Card>
 <Card title="Add Description" href="/v1.12.x/how-to-guides/guide-for-data-users/description" >
    Describe your data assets using Markdown
  </Card>
 <Card title="Request for Description" href="/v1.12.x/how-to-guides/guide-for-data-users/request-description" >
    Request for a description and discuss the same within OpenMetadata
  </Card>
 <Card title="Data Ownership" href="/v1.12.x/how-to-guides/guide-for-data-users/data-ownership" >
    Learn how to assign or change data owners
  </Card>
 <Card title="Follow a Data Asset" href="/v1.12.x/how-to-guides/guide-for-data-users/follow-data-asset" >
    Learn how to follow data assets
  </Card>
 <Card title="How to Add Tags" href="/v1.12.x/how-to-guides/guide-for-data-users/tags" >
    Add tags to data assets and learn about auto-PII classification.
  </Card>
 <Card title="Request for Tags" href="/v1.12.x/how-to-guides/guide-for-data-users/request-tags" >
    Request for tags and discuss about the same, all within OpenMetadata.
  </Card>
 <Card title="How to Add Glossary Terms" href="/v1.12.x/how-to-guides/guide-for-data-users/glossary" >
    Add glossary terms to data assets making it easier for data discovery
  </Card>
 <Card title="Custom Properties" href="/v1.12.x/how-to-guides/guide-for-data-users/custom" >
 ...
 <Card title="Create an Announcement" href="/v1.12.x/how-to-guides/guide-for-data-users/add-announcement" >
    Follow the steps to add an announcement
  </Card>
 <Card title="Data Asset Versioning" href="/v1.12.x/how-to-guides/guide-for-data-users/versions" >
    Review all the major and minor changes with version history
  </Card>
 <Card title="Delete a Data Asset" href="/v1.12.x/how-to-guides/guide-for-data-users/delete" >
    Soft, or hard delete data assets
  </Card>
 <Card title="OpenMetadata Chrome Extension" href="/v1.12.x/how-to-guides/guide-for-data-users/browser-ext" >
