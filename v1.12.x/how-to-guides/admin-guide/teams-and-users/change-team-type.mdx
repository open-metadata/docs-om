...
Refer to the [**Team Structure in OpenMetadata**](/v1.12.x/how-to-guides/admin-guide/teams-and-users/team-structure-openmetadata) to get a clear understanding of the various **Team Types**.
