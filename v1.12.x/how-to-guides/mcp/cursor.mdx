...
3. **[MCP Application and Personal Access Token](/v1.12.x/how-to-guides/guide-for-data-users/personal-access-token)** - Follow this guide to generate your PAT
...
5. **Token expired**: [Generate a new PAT](/v1.12.x/how-to-guides/guide-for-data-users/personal-access-token) and update your configuration
