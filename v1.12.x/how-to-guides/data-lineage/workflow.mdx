...
- **Filter Condition**: Enter a SQL condition to filter the data source's query-history results before OpenMetadata analyzes them for lineage and usage. For more information, see [Usage Query Filtering](/v1.12.x/connectors/ingestion/workflows/usage/filter-query-set).
