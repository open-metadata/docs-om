...
### Usage & Lineage
For the usage and lineage workflow, the user will need `SELECT` privilege on `STL_QUERY` table. You can find more information on the usage workflow [here](/v1.12.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v1.12.x/connectors/ingestion/workflows/lineage).
### IAM Authentication
