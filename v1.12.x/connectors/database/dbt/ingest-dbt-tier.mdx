...
For details on adding or selecting tiers, refer to the [OpenMetadata documentation](/v1.12.x/how-to-guides/data-governance/classification/tiers#what-are-tiers)
