...
- [Troubleshooting](/v1.12.x/connectors/pipeline/kafkaconnect/troubleshooting)
    - [Workflow Deployment Error](/v1.12.x/connectors/pipeline/kafkaconnect/troubleshooting#workflow-deployment-error)
## Requirements
...
- **Kafka Service Name** : The Service Name of the ingested [Kafka](/v1.12.x/connectors/messaging/kafka#metadata-ingestion) instance associated with this KafkaConnect instance.
</Step>
<TestConnection />
<ConfigureIngestion />
