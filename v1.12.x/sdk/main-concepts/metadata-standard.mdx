...
Curious about how OpenMetadata is built? You can take a look at the [High Level Design](/v1.12.x/main-concepts/high-level-design).
...
**2.** If you prefer to stay in the docs, we also have you covered. We have converted the JSON Schemas to markdown files
    ...
    end of each page. Again, this would be the structure of a [Table](/v1.12.x/main-concepts/metadata-standard).
