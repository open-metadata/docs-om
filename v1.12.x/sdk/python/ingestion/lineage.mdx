...
A **prerequisite** for this section is to have previously gone through the following [docs](/v1.12.x/sdk/python).
...
See the [Lineage Ingestion](/v1.12.x/connectors/pipeline) documentation for details.
</Info>
