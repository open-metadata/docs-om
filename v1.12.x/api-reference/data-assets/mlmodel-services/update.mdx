    ...
    data=json.dumps([
        {
            "op": "replace",
            "path": "/description",
            "value": "Updated: Production MLflow tracking server with model registry",
        },
        {
            "op": "replace",
            "path": "/connection/config/trackingUri",
            "value": "http://mlflow-prod:8088",
        },
        {
            "op": "replace",
            "path": "/connection/config/registryUri",
            "value": "http://mlflow-prod:8088",
        },
    ]),
)
