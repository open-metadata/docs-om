...
ometa = sdk_client().ometa

# Retrieve, modify a copy, and patch
topic = ometa.get_by_id(
    entity=Topic,
    entity_id="0a021819-982e-4ee4-a5a2-4af30eaa3016",
)
updated_topic = topic.model_copy(deep=True)
updated_topic.description = (
    "Updated: All Protobuf record events captured with enhanced schema"
)
updated = ometa.patch(entity=Topic, source=topic, destination=updated_topic)
