...
rest_client = ometa.client

# Soft delete by ID
ometa.delete(entity=Topic, entity_id="0a021819-982e-4ee4-a5a2-4af30eaa3016")
...
# Delete by name
rest_client.delete("/topics/name/sample_kafka.address_book")
...
# Restore a soft-deleted topic
ometa.restore(entity=Topic, entity_id="0a021819-982e-4ee4-a5a2-4af30eaa3016")
```
