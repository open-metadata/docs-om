...
For a complete, release-aligned custom source implementation, review the [Sample Data source](https://github.com/open-metadata/OpenMetadata/blob/1.12.14-release/ingestion/src/metadata/ingestion/source/database/sample_data.py).
