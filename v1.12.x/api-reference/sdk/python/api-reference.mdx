...
- [`models.EntityList`](/v1.12.x/api-reference/sdk/python/api-reference/models#class-entitylist): Paginated entity list container
...
- [`client_utils.get_chart_entities_from_id`](/v1.12.x/api-reference/sdk/python/api-reference/client-utils#function-get_chart_entities_from_id): Method to get the chart entity using get_by_name api
