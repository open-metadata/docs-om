...
See the [Collate AI SDK documentation](https://docs.getcollate.io/sdk/ai) for the full agent capabilities.
...
## AI Studio Agents (Collate)

<Note>

The following sections cover **AI Studio Agents** — a [Collate](https://www.getcollate.io) feature that lets you
create and invoke purpose-built AI assistants. If you are using self-hosted OpenMetadata, skip to
[MCP Tools](#mcp-tools) to learn how to connect any LLM to your metadata.
