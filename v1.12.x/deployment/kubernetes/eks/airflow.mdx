...
Create RDS and OpenSearch credentials as Kubernetes Secrets, as described [here](/v1.12.x/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).
