...
Create CloudSQL and Elasticsearch credentials as Kubernetes Secrets, as described [here](/v1.12.x/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).
...
Please validate:
- all the prerequisites mentioned in this [section](/v1.12.x/deployment/kubernetes/gke#prerequisites)
