...
This page contains code examples for running each workflow type externally. For framework setup, configuration, and JWT token handling, see the [External Ingestion Overview](/v1.12.x/deployment/ingestion/external).
...
Moreover, see how we are not configuring any tests in the `processor`. You can configure them in the [advanced YAML example](/v1.12.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/advanced-usage#yaml-file-structure),
