...
2. [Docker Operator](/v1.12.x/deployment/ingestion/external/airflow-docker-virtualenv#using-the-docker-operator)
3. [Python Virtualenv Operator](/v1.12.x/deployment/ingestion/external/airflow-docker-virtualenv#using-the-python-virtualenv-operator)
