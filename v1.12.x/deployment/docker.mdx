...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.12.0-release/docker-compose-openmetadata.yml
```
...
- Amazon OpenSearch (ElasticSearch) engine version 9.3.0 or higher, or Amazon OpenSearch engine version 3.3.0 or higher
