...
OpenMetadata supports ElasticSearch version 9.3.0 or higher, and OpenSearch version 3.3.0 or higher. To install or upgrade Elasticsearch to a supported version please see the instructions for your operating system at
...
If you are using AWS OpenSearch Service, OpenMetadata supports AWS OpenSearch Service engine version 3.3.0 or higher. For more information on AWS OpenSearch Service, please visit the official docs [here](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/what-is.html).
...
the ingestion workflows [here](/v1.12.x/deployment/ingestion).
...
[here](/v1.12.x/deployment/configuration).
...
Please follow our [Enable Security Guide](/v1.12.x/deployment/bare-metal/security) to configure security for your OpenMetadata
installation.
