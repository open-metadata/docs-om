...
import ConfigureIngestion from '/snippets/v1.12.x/deployment/configure-ingestion.mdx'
...
configuration. To know how to enable it, you can follow the documentation of [Enable JWT Tokens](/v1.12.x/deployment/security/enable-jwt-tokens).
