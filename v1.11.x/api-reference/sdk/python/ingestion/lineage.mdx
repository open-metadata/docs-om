...
A **prerequisite** for this section is to have previously gone through the following [docs](/v1.11.x/api-reference/sdk/python).
...
See the [Lineage Ingestion](/v1.11.x/connectors/pipeline) documentation for details.
</Info>
