...
# Get by ID
svc = client.get("/services/mlmodelServices/ca22d46e-81b9-4e48-85b5-0adc44980da9")
print(f"{svc['fullyQualifiedName']}: {svc['serviceType']}")

# Get by ID with fields
svc = client.get(
    "/services/mlmodelServices/ca22d46e-81b9-4e48-85b5-0adc44980da9",
    data={"fields": "owners,tags"},
)

# Get by fully qualified name
svc = client.get("/services/mlmodelServices/name/mlflow_svc")

# Get by name with fields
svc = client.get(
    "/services/mlmodelServices/name/mlflow_svc",
    data={"fields": "owners,tags,domains"},
)
```
