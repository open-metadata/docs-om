...
# Soft delete by ID
client.delete("/services/storageServices/d1589e1d-2ab0-431c-a383-15e4be20a106")
...
# Delete by name
client.delete("/services/storageServices/name/s3_datalake")

# Delete by name with options
client.delete(
    "/services/storageServices/name/s3_datalake"
    "?hardDelete=true&recursive=true"
)

# Restore a soft-deleted storage service
client.put(
    "/services/storageServices/restore",
    json={"id": "d1589e1d-2ab0-431c-a383-15e4be20a106"},
)
```
