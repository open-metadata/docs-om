...
<CardGroup>
  <Card title="Why Open Metadata is the Right Choice for you?" href="/v1.11.xhttps://blog.open-metadata.org/why-openmetadata-is-the-right-choice-for-you-59e329163cac">
...
<CardGroup>
  <Card title="High Level Design" href="/v1.11.x/main-concepts/high-level-design">
...
<CardGroup cols={2}>
  <Card title="OpenMetadata Schemas" href="/v1.11.x/main-concepts/metadata-standard/schemas">
    Review the standard that powers OpenMetadata with JSON Schema.
  </Card>
  <Card title="OpenMetadata APIs" href="/v1.11.x/main-concepts/metadata-standard/apis">
