...
<CardGroup cols={2}>
<Card title="Trigger" href="/v1.11.x/how-to-guides/data-governance/workflows/elements/triggers" >
    Defines what initiates a workflow (e.g., an event or a scheduled action)
  </Card>
 <Card title="Nodes" href="/v1.11.x/how-to-guides/data-governance/workflows/elements/nodes" >
