...
<a href="/v1.11.x{{baseUrl}}/entity/{{event.entityType}}/{{entity.id}}">
...
```handlebars
<a href="/v1.11.x{{buildEntityUrl event.entityType entity}}">
  View in OpenMetadata
</a>
```
...
<p><a href="/v1.11.x{{buildEntityUrl event.entityType entity}}">
...
<footer>
  <small>
    ...
    <a href="/v1.11.x{{baseUrl}}">OpenMetadata</a>
  </small>
</footer>
```
