...
Users can also set up [alerts](/v1.11.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) to be notified when a test fails.

 <Card title="How to Set Alerts for Test Case Fails" href="/v1.11.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts" >
