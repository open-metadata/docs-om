...
<CardGroup cols={2}>
<Card title="How to Discover Assets of Interest" href="/v1.11.x/how-to-guides/data-discovery/discover" >
    Discover the right data assets quickly.
  </Card>
 <Card title="Get a Quick Glance of the Data Assets" href="/v1.11.x/how-to-guides/data-discovery/preview" >
    Quick preview of the selected data asset.
  </Card>
 <Card title="Data Asset Details" href="/v1.11.x/how-to-guides/data-discovery/details" >
    Get a holistic view of the data assets.
  </Card>
 <Card title="Using Advanced Search" href="/v1.11.x/how-to-guides/data-discovery/advanced" >
