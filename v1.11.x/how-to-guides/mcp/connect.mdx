...
### 2. Authentication
The MCP server requires [JWT authentication](/v1.11.x/how-to-guides/mcp#adding-a-personal-access-token-to-your-mcp-client). Include your token in the Authorization header:
```http
