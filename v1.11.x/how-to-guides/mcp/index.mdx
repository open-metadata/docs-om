...
<CardGroup cols={2}>
<Card title="Collate MCP Server Connection Guide" href="/v1.11.x/v1.11.x/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="Collate MCP Tools Reference" href="/v1.11.x/v1.11.x/how-to-guides/mcp/reference" >
    Detailed examples and usage patterns for all available Collate MCP tools.
  </Card>
 <Card title="Getting Started with Claude Desktop" href="/v1.11.x/v1.11.x/how-to-guides/mcp/claude" >
    Connect your Collate to Anthropic's popular AI assistant.
  </Card>
 <Card title="Getting Started with Goose" href="/v1.11.x/v1.11.x/how-to-guides/mcp/goose" >
