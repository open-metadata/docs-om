---
title: MCP Server
slug: /v1.11.x/how-to-guides/mcp
...
<CardGroup cols={2}>
<Card title="OpenMetadata MCP Server Connection Guide" href="/v1.11.x/how-to-guides/mcp/connect" >
    Connect to your MCP Server.
  </Card>
 <Card title="OpenMetadata MCP Tools Reference" href="/v1.11.x/how-to-guides/mcp/reference" >
