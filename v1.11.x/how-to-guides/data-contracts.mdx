...
<CardGroup cols={2}>
<Card title="OpenMetadata Data Contract Specification" href="/v1.11.x/how-to-guides/data-contracts/spec" >
    Overview of JSON Schema for DataContract entity
  </Card>
 <Card title="Creating a Data Contract" href="/v1.11.x/how-to-guides/data-contracts/create" >
