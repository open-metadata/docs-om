...
OpenMetadata integrates with Airflow to orchestrate ingestion workflows. You can use Airflow to [extract metadata](/v1.11.x/connectors/pipeline/airflow) and [deploy workflows] (/deployment/ingestion/openmetadata) directly. This guide explains how to run ingestion workflows in Airflow using three different operators:
...
<Card title="Docker & Virtualenv Operators" href="/v1.11.x/deployment/ingestion/external/airflow-docker-virtualenv">
