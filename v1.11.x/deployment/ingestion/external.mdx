...
<Info>
For code examples running Metadata, Lineage, Usage, Profiler, and Data Quality workflows externally, see [Workflow Examples](/v1.11.x/deployment/ingestion/external/examples).
</Info>
