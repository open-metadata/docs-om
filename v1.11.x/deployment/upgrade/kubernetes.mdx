...
[Kubernetes Deployment](/v1.11.x/deployment/kubernetes) guide.
...
You can learn more about how the migration process works [here](/v1.11.x/deployment/upgrade/how-does-it-work).
