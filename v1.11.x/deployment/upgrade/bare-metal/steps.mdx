...
Follow the steps below to upgrade your OpenMetadata bare-metal deployment. Before proceeding, make sure you have completed the [prerequisites](/v1.11.x/deployment/upgrade/bare-metal).
