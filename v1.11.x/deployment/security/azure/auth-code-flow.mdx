...
<CardGroup cols={3}>
<Card title="Docker" href="/v1.11.x/deployment/security/azure/docker" >
  Configure Azure SSO for Docker deployment.
</Card>
<Card title="Kubernetes" href="/v1.11.x/deployment/security/azure/kubernetes" >
  Configure Azure SSO for Kubernetes deployment.
</Card>
<Card title="Bare Metal" href="/v1.11.x/deployment/security/azure/bare-metal" >
  Configure Azure SSO for Bare Metal deployment.
</Card>
</CardGroup>

<CardGroup cols={1}>
<Card title="Azure" href="/v1.11.x/deployment/security/azure" >
