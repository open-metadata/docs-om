...
<div>
<a href="/v1.11.x/deployment/production-ready-requirements" className="button-link">Learn More <img src="/public/images/homepage-icons/right-arrow.svg" alt="Right arrow" /></a>
</div>
