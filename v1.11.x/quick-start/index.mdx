...
<Columns cols={2}>
  <Card
    ...
    href="/v1.11.x/quick-start/sandbox"
    horizontal
  >
...
<Columns cols={2}>
  <Card
    ...
    href="/v1.11.x/quick-start/local-docker-deployment"
    horizontal
  >
  ...
  <Card
    ...
    href="/v1.11.x/quick-start/local-kubernetes-deployment"
    horizontal
  >
...
<Columns cols={2}>
  <Card
    ...
    href="/v1.11.x/quick-start/getting-started"
    horizontal
  >
