...
<CardGroup cols={1}>
<Card title="Run the connector in OpenMetadata" icon="plug" href="/quick-start/getting-started/day-1/database-service-setup">
...
<img src="/public/images/v1.11/getting-started/add-ingestion0.png" alt="Ingestion Navigation" />

- Go to the **Agents** tab and click **Add Metadata Agent**.

<img src="/public/images/v1.11/getting-started/add-ingestion.png" alt="Adding Ingestion" />
...
<img src="/public/images/v1.11/getting-started/ingestion-config.png" alt="Configure Ingestion" />

- Schedule the pipeline to ingest metadata at regular intervals.

<img src="/public/images/v1.11/getting-started/schedule-ingesgtion.png" alt="Schedule Ingestion" />
...
<img src="/public/images/v1.11/getting-started/explore-tab.png" alt="Ingested Data" />
...
<img src="/public/images/v1.11/how-to-guides/admin-guide/email.png" alt="Email Configuration" />
...
<img src="/public/images/v1.11/getting-started/users.png" alt="Users Navigation" />

- Click **Add User**, then enter their email and other required details to grant access to the platform.

<img src="/public/images/v1.11/getting-started/add-users.png" alt="Adding New User" />
...
<img src="/public/images/v1.11/getting-started/update-user.png" alt="Users Profile" />
...
<CardGroup cols={2}>
<Card title="Data Discovery" icon="magnifying-glass" href="/how-to-guides/data-discovery">
Discover the right data assets to make timely business decisions.
</Card>
<Card title="Data Collaboration" icon="users" href="/how-to-guides/data-collaboration">
Foster data team collaboration to enhance data understanding.
</Card>
<Card title="Data Quality & Observability" icon="chart-line" href="/how-to-guides/data-quality-observability">
Trust your data with quality tests & monitor the health of your data systems.
</Card>
<Card title="Data Lineage" icon="diagram-project" href="/how-to-guides/data-lineage">
Trace the path of data across tables, pipelines, and dashboards.
</Card>
<Card title="Data Insights" icon="lightbulb" href="/how-to-guides/data-insights">
Define KPIs and set goals to proactively hone the data culture of your company.
</Card>
<Card title="Data Governance" icon="shield-check" href="/how-to-guides/data-governance">
...
<CardGroup cols={2}>
<Card title="Admin Guide" icon="gear" href="/how-to-guides/admin-guide">
Admin users can get started with OpenMetadata with just three quick and easy steps & know-it-all with the advanced guides.
</Card>
<Card title="Guide for Data Users" icon="user" href="/how-to-guides/guide-for-data-users">
