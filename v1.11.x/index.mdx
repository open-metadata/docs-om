...
import { Integrations } from "/snippets/v1.11.x/components/ConnectorGrid/Integration.jsx"
...
<a href="/v1.11.x/connectors/database/databricks" className="chip purple">
  <Icon icon="/public/images/connectors/databrick.webp" color="#6938EF" /> <span>Databricks</span>
</a>

<a href="/v1.11.x/connectors/database/bigquery" className="chip purple">
  <Icon icon="/public/images/connectors/bigquery.webp" color="#6938EF" /> <span>BigQuery</span>
</a>

<a href="/v1.11.x/connectors/database/redshift" className="chip purple">
  <Icon icon="/public/images/connectors/redshift.webp" color="#6938EF" /> <span>Redshift</span>
</a>

<a href="/v1.11.x/connectors/database/snowflake" className="chip purple">
...
<a className="read-more" href="/v1.11.x/quick-start">
    <span>Read More</span>
...
<a className="read-more" href="/v1.11.x/deployment">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
...
<a className="read-more" href="/v1.11.x/deployment/upgrade">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
...
<a href="https://sandbox.open-metadata.org/" target="_blank">Explore Collate</a>
</div>
...
<a href="/v1.11.x/how-to-guides/data-discovery" className="guide-card">
  <Icon icon="/public/images/homepage-icons/discovery.svg" />
  <div>Discovery</div>
</a>

<a href="/v1.11.x/how-to-guides/data-lineage" className="guide-card">
  <Icon icon="/public/images/homepage-icons/lineage.svg" />
  <div>Lineage</div>
</a>

<a href="/v1.11.x/how-to-guides/data-quality-observability" className="guide-card">
  <Icon icon="/public/images/homepage-icons/observability.svg" />
  <div>Observability</div>
</a>

<a href="/v1.11.x/how-to-guides/data-insights" className="guide-card">
  <Icon icon="/public/images/homepage-icons/insights.svg" />
  <div>Insights</div>
</a>

<a href="/v1.11.x/how-to-guides/data-contracts" className="guide-card">
  <Icon icon="/public/images/homepage-icons/contract.svg" />
  <div>Data Contract</div>
</a>

<a href="/v1.11.x/how-to-guides/data-governance" className="guide-card">
  <Icon icon="/public/images/homepage-icons/governance.svg" />
  <div>Governance</div>
</a>

<a href="/v1.11.x/connectors" className="guide-card">
...
<a href="/v1.11.x/how-to-guides">See All</a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.11.x/how-to-guides/mcp">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.11.x/how-to-guides/data-quality-observability/quality/dimensional-validation">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<div className="highlight-card">
  ...
  <a className="read-more" href="/v1.11.x/how-to-guides/data-quality-observability/quality/data-quality-as-code">
    <span>Read More</span>
    <img noZoom src="/public/images/homepage-icons/right-arrow.svg" alt="Right Arrow" />
  </a>
</div>
...
<a href="/v1.11.x/how-to-guides/mcp">MCP Server</a>
<a href="/v1.11.x/how-to-guides/data-contracts">Data Contracts</a>
<a href="/v1.11.x/how-to-guides/data-quality-observability/quality/data-quality-as-code">Data Quality as Code</a>
<a href="/v1.11.x/how-to-guides/data-quality-observability/quality/dimensional-validation">Dimensional Validation</a>
</div>
</div>
...
See OpenMetadata in Action
</h2>
<p className="video-description">
Want a quick overview? Take a quick tour - watch our detailed demo to learn how OpenMetadata works.
</p>
</div>
...
<iframe
  className="video"
  src="https://www.youtube.com/embed/kNNzuTnV8EM?si=0OFfB8iOZTzCsT1w"
