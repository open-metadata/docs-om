...
1. **Completed the OpenMetadata UI setup** - Follow all pre-requisites in the [OpenMetadata UI](/v1.11.x/developers/contribute/build-code-and-run-tests/openmetadata-ui) section, which covers Node.js, Yarn, and other dependencies.
...
- [OpenMetadata Testing Guidelines](/v1.11.x/developers/contribute/build-code-and-run-tests)
