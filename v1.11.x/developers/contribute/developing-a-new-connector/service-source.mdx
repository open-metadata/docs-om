...
description: Understand the Service Source abstract class and implement the required methods for your OpenMetadata connector.
sidebarTitle: Service Source
---
...
<Card title="Apply the UI Changes" href="/v1.11.x/developers/contribute/developing-a-new-connector/apply-ui-changes" >
