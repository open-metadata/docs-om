...
See the [Storage Configuration Overview](/v1.11.x/connectors/database/dbt/storage-configuration-overview) for setup guides:
- [AWS S3](/v1.11.x/connectors/database/dbt/storage-s3-guide) | [Google Cloud Storage](/v1.11.x/connectors/database/dbt/storage-gcs-guide) | [Azure Blob](/v1.11.x/connectors/database/dbt/storage-azure-guide) | [HTTP Server](/v1.11.x/connectors/database/dbt/storage-http-guide) | [Local/Shared Filesystem](/v1.11.x/connectors/database/dbt/storage-local-guide)
...
Follow the link [here](/v1.11.x/connectors/database/dbt/setup-multiple-dbt-projects) for instructions on setting up multiple dbt projects.
...
To know how to get the values for `Dbt Cloud Account Id`, `Dbt Cloud Project Id` and `Dbt Cloud Job Id` fields check [here](/v1.11.x/connectors/database/dbt/run-dbt-workflow-externally).
