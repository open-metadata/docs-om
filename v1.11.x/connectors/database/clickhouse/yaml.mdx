...
### Usage & Lineage
For the usage and lineage workflow, the user will need `SELECT` privilege. You can find more information on the usage workflow [here](/v1.11.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v1.11.x/connectors/ingestion/workflows/lineage).
### Python Requirements
<PythonRequirements />
