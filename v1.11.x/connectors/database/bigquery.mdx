...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.11.x/connectors/ingestion/workflows/metadata/incremental-extraction/bigquery)
...
- [Data Quality](/v1.11.x/how-to-guides/data-quality-observability/quality/configure)
- [Lineage](/v1.11.x/connectors/ingestion/lineage)
- [dbt Integration](/v1.11.x/connectors/database/dbt)
- [Troubleshooting](/v1.11.x/connectors/database/bigquery/troubleshooting)

<ExternalIngestionDeployment />
## Requirements
You need to create an service account in order to ingest metadata from bigquery refer [this](/v1.11.x/connectors/database/bigquery/create-credentials) guide on how to create service account.
<Columns cols={2}>
<Card title="Create Custom GCP Role" href="/v1.11.x/connectors/database/bigquery/create-credentials">
