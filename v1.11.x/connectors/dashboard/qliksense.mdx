...
- [Lineage](#lineage)
- [Troubleshooting](/v1.11.x/connectors/dashboard/qliksense/troubleshooting)
## Requirements
<Card title="OpenMetadata 1.1.1 or later" href="/v1.11.x/deployment" >
...
Refer to the guide on how to generate authentication certificates so that OpenMetadata can communicate with Qlik Sense [here](/v1.11.x/connectors/dashboard/qliksense/certificates).
