...
Webhooks were deprecated in 0.13.1. Use [OpenMetadata alerts](/v1.13.x/how-to-guides/data-quality-observability/alerts-notifications/data-observability-alerts) instead, which let you configure customized alerts on updates using triggers and filters, delivered to destinations like Slack, Microsoft Teams, or email.
