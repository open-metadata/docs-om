...
<Info>
For entity resolution, cross-database lineage, stored procedures, parallel processing, publishing, dialect mapping, and configuration, see [Lineage Ingestion — Advanced Topics](/v1.13.x-SNAPSHOT/developers/contribute/codebase-deep-dives/lineage-ingestion/advanced).
</Info>
