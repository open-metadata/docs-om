...
<Card title="OpenMetadata 1.6.0 or later" href="/v1.13.x/deployment" >
...
<Card title="Performance & Memory Management" href="/v1.13.x/developers/contribute/developing-a-new-connector/performance-and-memory">
