...
<Info>
Both configurations automatically install all [prerequisites](/v1.13.x/developers/contribute/build-code-and-run-tests/prerequisites) — no manual dependency setup required.
</Info>
...
<CardGroup cols={2}>
  <Card title="Build Code and Run Tests" icon="hammer" href="/v1.13.x/developers/contribute/build-code-and-run-tests">
    Learn how to build individual components and run the test suite.
  </Card>
  <Card title="Develop a New Connector" icon="plug" href="/v1.13.x/developers/contribute/developing-a-new-connector">
