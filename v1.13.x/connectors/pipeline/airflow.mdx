...
- [REST API Connection](/v1.13.x-SNAPSHOT/connectors/pipeline/airflow/rest-api-connection)
- [Troubleshooting](/v1.13.x-SNAPSHOT/connectors/pipeline/airflow/troubleshooting)
...
- `RestAPI`: Connects to Airflow via the web server REST API. No direct database access required — ideal for managed
    ...
    See the [REST API Connection guide](/v1.13.x-SNAPSHOT/connectors/pipeline/airflow/rest-api-connection) for full setup instructions.
