...
- [Troubleshooting](/v1.13.x/connectors/pipeline/glue-pipeline/troubleshooting)
...
- **Kafka Service Name** : The Service Name of the Ingested [Kafka](/v1.13.x/connectors/messaging/kafka#4.-name-and-describe-your-service) instance associated with this KafkaConnect instance.
</Step>
<TestConnection />
<ConfigureIngestion />
