...
- [Troubleshooting](/v1.13.x/connectors/pipeline/kafkaconnect/troubleshooting)
    - [Workflow Deployment Error](/v1.13.x/connectors/pipeline/kafkaconnect/troubleshooting#workflow-deployment-error)
## Requirements
...
- **Kafka Service Name** : The Service Name of the ingested [Kafka](/v1.13.x/connectors/messaging/kafka#metadata-ingestion) instance associated with this KafkaConnect instance.
</Step>
<TestConnection />
<ConfigureIngestion />
...
* [MySQL](/v1.13.x/connectors/database/mysql)
* [PostgreSQL](/v1.13.x/connectors/database/postgres)
* [MSSQL](/v1.13.x/connectors/database/mssql)
* [MongoDB](/v1.13.x/connectors/database/mongodb)
* [Amazon S3](/v1.13.x/connectors/storage/s3)
