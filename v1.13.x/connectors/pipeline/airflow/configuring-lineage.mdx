...
Regardless of the Airflow ingestion process you follow ([Workflow](/v1.13.x/connectors/pipeline/airflow),
[Lineage Backend](/v1.13.x/connectors/pipeline/airflow/lineage-backend) or [Lineage Operator](/v1.13.x/connectors/pipeline/airflow/lineage-operator)),
