---
title: Database & Schema Filter Patterns | Official Documentation
description: Filter metadata patterns at the database and schema level using YAML configuration to fine-tune what assets are ingested.
