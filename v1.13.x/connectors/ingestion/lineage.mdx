...
The main difference here is between those sources that provide internal access to query logs and those that do not. For services such as [BigQuery](/v1.13.x/connectors/database/bigquery), [Snowflake](/v1.13.x/connectors/database/snowflake) etc.
...
the [workflow](/v1.13.x/connectors/ingestion/workflows/usage/usage-workflow-query-logs).
...
The supported services here are [Airflow](/v1.13.x/connectors/pipeline/airflow),
[Fivetran](/v1.13.x/connectors/pipeline/fivetran), [Dagster](/v1.13.x/connectors/pipeline/dagster)
and [Airbyte](/v1.13.x/connectors/pipeline/airbyte).
...
[here](/v1.13.x/connectors/pipeline/airflow/lineage-backend#adding-lineage).
...
<CardGroup cols={1}>
<Card title="Manual Lineage" href="/v1.13.x/connectors/ingestion/lineage/edit-lineage-manually" >
