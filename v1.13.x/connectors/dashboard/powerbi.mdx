...
Refer to the [Power BI Admin and Non-Admin APIs](/v1.13.x/connectors/dashboard/powerbi#powerbi-admin-and-non-admin-apis) section for more information.
- Enabled (Use PowerBI Admin APIs)
- Disabled (Use Non-Admin PowerBI APIs)
</Step>
<TestConnection />
