...
all the required methods in the [`Source` interface](https://github.com/open-metadata/OpenMetadata/blob/1.13.0-release/ingestion/src/metadata/ingestion/api/steps.py#L34).
...
to send all the Create Entity Requests to the `Sink`. Read the [workflow architecture](https://github.com/open-metadata/OpenMetadata/blob/1.13.0-release/ingestion/src/metadata/workflow/README.md) for details.
