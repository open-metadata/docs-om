...
For the required database privileges, see the [Requirements section of the Exasol connector documentation](/v1.13.x/connectors/database/exasol#requirements).
