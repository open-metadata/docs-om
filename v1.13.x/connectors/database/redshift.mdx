...
- [Metadata Ingestion](#metadata-ingestion)
    - [Incremental Extraction](/v1.13.x/connectors/ingestion/workflows/metadata/incremental-extraction/redshift)
...
- [Troubleshooting](/v1.13.x/connectors/database/redshift/troubleshooting)
...
```
More information on the profiler workflow setup can be found [here](/v1.13.x/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v1.13.x/how-to-guides/data-quality-observability/quality).
### Usage & Lineage
...
You can find more information on the usage workflow [here](/v1.13.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v1.13.x/connectors/ingestion/workflows/lineage).
### Stored Procedures
