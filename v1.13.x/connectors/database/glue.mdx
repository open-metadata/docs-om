...
- [Troubleshooting](/v1.13.x/connectors/database/glue/troubleshooting)
## Requirements
...
## Database Name
Glue maps the OpenMetadata `Database` level to an AWS Glue Data Catalog. In the **Database Name** field, enter the [Glue Catalog ID](https://docs.aws.amazon.com/glue/latest/dg/glue-specifying-resource-arns.html#data-catalog-resource-arns)—not the name of a Glue database. For the default catalog, the Catalog ID is usually the AWS account ID.

Leave the field blank to let the connector discover the available Glue Catalog IDs. Glue database names appear as schemas in OpenMetadata.
# Connection Details
<Steps>
