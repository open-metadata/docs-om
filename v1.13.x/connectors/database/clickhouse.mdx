...
- [Metadata Ingestion](#metadata-ingestion)
    - [Service Name](#metadata-ingestion)
    - [Connection Options](#connection-options)
    - [Metadata Ingestion Options](#metadata-ingestion-options)
- [Troubleshooting](/v1.13.x/connectors/database/clickhouse/troubleshooting)
    - [Workflow Deployment Error](/v1.13.x/connectors/database/clickhouse/troubleshooting#workflow-deployment-error)
- [Related](#related)
...
### Usage & Lineage
For the usage and lineage workflow, the user will need `SELECT` privilege. You can find more information on the usage workflow [here](/v1.13.x/connectors/ingestion/workflows/usage) and the lineage workflow [here](/v1.13.x/connectors/ingestion/workflows/lineage).
## Metadata Ingestion
