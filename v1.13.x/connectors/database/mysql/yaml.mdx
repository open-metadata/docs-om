...
- You can learn more about how to configure and run the Lineage Workflow to extract Lineage data from [here](/v1.13.x/connectors/ingestion/workflows/lineage)
...
## dbt Integration
<Columns cols={2}>
<Card title="dbt Integration" href="/v1.13.x/connectors/database/dbt">
