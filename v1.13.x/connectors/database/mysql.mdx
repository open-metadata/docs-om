...
- [Data Lineage](/v1.13.x/how-to-guides/data-lineage/workflow)
- [Troubleshooting](/v1.13.x/connectors/database/mysql/troubleshooting)
...
Executing the profiler workflow or data quality tests, will require the user to have `SELECT` permission on the tables/schemas where the profiler/tests will be executed. More information on the profiler workflow setup can be found [here](/v1.13.x/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v1.13.x/how-to-guides/data-quality-observability/quality).
## Metadata Ingestion
