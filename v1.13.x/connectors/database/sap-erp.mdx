...
- [Troubleshooting](/v1.13.x/connectors/database/sap-erp/troubleshooting)
## Requirements
...
Follow the guide [here](/v1.13.x/connectors/database/sap-erp/setup-sap-apis) to setup the APIs.
## Metadata Ingestion
