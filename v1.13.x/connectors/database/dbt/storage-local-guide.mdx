...
- [S3 Storage](/v1.13.x/connectors/database/dbt/storage-s3-guide) for AWS
- [GCS Storage](/v1.13.x/connectors/database/dbt/storage-gcs-guide) for GCP
- [Azure Blob Storage](/v1.13.x/connectors/database/dbt/storage-azure-guide) for Azure
...
<Note>
See other storage options: [S3](/v1.13.x/connectors/database/dbt/storage-s3-guide) | [GCS](/v1.13.x/connectors/database/dbt/storage-gcs-guide) | [Azure](/v1.13.x/connectors/database/dbt/storage-azure-guide) | [HTTP](/v1.13.x/connectors/database/dbt/storage-http-guide) | [dbt Cloud](/v1.13.x/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
