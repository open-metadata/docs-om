...
**Setup:**
1. Follow [S3 guide](/v1.13.x/connectors/database/dbt/storage-s3-guide) to create bucket and upload artifacts
...
- [Configure dbt Workflow](/v1.13.x/connectors/database/dbt/configure-dbt-workflow)
- [dbt Troubleshooting](/v1.13.x/connectors/database/dbt/dbt-troubleshooting)

<Note>
See other storage options: [S3](/v1.13.x/connectors/database/dbt/storage-s3-guide) | [GCS](/v1.13.x/connectors/database/dbt/storage-gcs-guide) | [Azure](/v1.13.x/connectors/database/dbt/storage-azure-guide) | [Local](/v1.13.x/connectors/database/dbt/storage-local-guide) | [dbt Cloud](/v1.13.x/connectors/database/dbt/dbt-cloud-api-guide)
</Note>
