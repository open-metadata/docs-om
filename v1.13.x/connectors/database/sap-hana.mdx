...
- [Lineage](/v1.13.x/how-to-guides/data-lineage/workflow)
- [Data Quality](/v1.13.x/how-to-guides/data-quality-observability/quality)
- [dbt Integration](/v1.13.x/connectors/database/dbt)
- [Troubleshooting](/v1.13.x/connectors/database/sap-hana/troubleshooting)
## Requirements
<Tip>
...
Executing the profiler Workflow or data quality tests, will require the user to have `SELECT` permission on the tables/schemas where the profiler/tests will be executed. The user should also be allowed to view information in `tables` for all objects in the database. More information on the profiler workflow setup can be found [here](/v1.13.x/how-to-guides/data-quality-observability/profiler/profiler-workflow) and data quality tests [here](/v1.13.x/how-to-guides/data-quality-observability/quality).
## Metadata Ingestion
