...
For OpenMetadata 1.13.1, install a package from the matching server patch line:
...
- [Browse the Python SDK reference](https://github.com/open-metadata/OpenMetadata/blob/1.13.1-release/ingestion/src/metadata/sdk/README.md).
