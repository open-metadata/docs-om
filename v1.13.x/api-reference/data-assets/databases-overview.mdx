...
|----------|-----------|-------------|
| [Database Services](/v1.13.x/api-reference/data-assets/database-services) | `/v1/services/databaseServices` | Manage database platform connections |
| [Databases](/v1.13.x/api-reference/data-assets/databases) | `/v1/databases` | Manage databases within a service |
| [Database Schemas](/v1.13.x/api-reference/data-assets/database-schemas) | `/v1/databaseSchemas` | Manage schemas within a database |
| [Tables](/v1.13.x/api-reference/data-assets/tables) | `/v1/tables` | Manage tables within a schema |
| [Stored Procedures](/v1.13.x/api-reference/data-assets/stored-procedures) | `/v1/storedProcedures` | Manage stored procedures within a schema |
