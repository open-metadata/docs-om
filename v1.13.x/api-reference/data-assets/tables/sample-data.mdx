...
# Get sample data
table = Tables.get_sample_data(table_id)
if table and table.sampleData:
...
Tables.add_sample_data(table_id, sample_data)

# Delete sample data with the REST request in the cURL example.
```
