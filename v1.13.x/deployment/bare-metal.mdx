...
[here](/v1.13.x/deployment/configuration).
...
Please follow our [Enable Security Guide](/v1.13.x/deployment/bare-metal/security) to configure security for your OpenMetadata
installation.
