...
OpenMetadata integrates with Airflow to orchestrate ingestion workflows. You can use Airflow to [extract metadata](/v1.13.x/connectors/pipeline/airflow) and [deploy workflows] (/deployment/ingestion/openmetadata) directly. This guide explains how to run ingestion workflows in Airflow using three different operators:

1. [Python Operator](#using-the-python-operator)
2. [Docker Operator](/v1.13.x/deployment/ingestion/external/airflow-docker-virtualenv#using-the-docker-operator)
3. [Python Virtualenv Operator](/v1.13.x/deployment/ingestion/external/airflow-docker-virtualenv#using-the-python-virtualenv-operator)
...
-Replace x.y.z with the OpenMetadata version matching your server (e.g., 1.13.5).

### Example
```
pip3 install openmetadata-ingestion[mysql,snowflake,s3]==1.13.5
```
### Example DAG
...
<Card title="Docker & Virtualenv Operators" href="/v1.13.x/deployment/ingestion/external/airflow-docker-virtualenv">
