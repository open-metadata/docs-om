...
- **Image Version**: Ensure the Docker image version matches your OpenMetadata server version (e.g., `openmetadata/ingestion-base:1.13.6`).
...
with DAG(
    ...
    ingest_task = PythonVirtualenvOperator(
        ...
        requirements=[
            'openmetadata-ingestion[mysql]~=1.13.6',  # Specify any additional Python package dependencies
        ],
