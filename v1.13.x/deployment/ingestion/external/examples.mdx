...
Moreover, see how we are not configuring any tests in the `processor`. You can do [that](/v1.13.x/how-to-guides/data-quality-observability/quality/configure#full-yaml-config-example),
