...
For example, if you are using the [Glue](/v1.13.x/connectors/database/glue) connector you could specify the
...
You can validate the whole Google service account setup [here](/v1.13.x/deployment/security/google).
...
[Using Airflow Connections](/v1.13.x/deployment/ingestion/external/credentials-airflow).
