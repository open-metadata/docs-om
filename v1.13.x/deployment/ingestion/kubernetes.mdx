...
<Info>
For validating your setup, viewing pipeline logs, troubleshooting, and migrating from Airflow, see the [Operations & Troubleshooting](/v1.13.x/deployment/ingestion/kubernetes/troubleshooting) guide.
</Info>
