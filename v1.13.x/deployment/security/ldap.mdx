...
<CardGroup cols={3}>
<Card title="Docker" href="/v1.13.x/deployment/security/ldap/docker" >
  Configure LDAP Authentication for Docker deployment.
</Card>
<Card title="Kubernetes" href="/v1.13.x/deployment/security/ldap/kubernetes" >
  Configure LDAP Authentication for Kubernetes deployment.
</Card>
<Card title="Bare Metal" href="/v1.13.x/deployment/security/ldap/bare-metal" >
