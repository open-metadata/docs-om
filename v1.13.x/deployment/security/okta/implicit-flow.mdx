...
<CardGroup cols={3}>
<Card title="Docker" href="/v1.13.x/deployment/security/okta/docker" >
  Configure Okta SSO for Docker deployment.
</Card>
<Card title="Kubernetes" href="/v1.13.x/deployment/security/okta/kubernetes" >
  Configure Okta SSO for Kubernetes deployment.
</Card>
<Card title="Bare Metal" href="/v1.13.x/deployment/security/okta/bare-metal" >
  Configure Okta SSO for Bare Metal deployment.
</Card>
</CardGroup>

<CardGroup cols={1}>
<Card title="OKTA" href="/v1.13.x/deployment/security/okta" >
