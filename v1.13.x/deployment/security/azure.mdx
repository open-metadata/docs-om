...
- **DELETE** the admin default account shipped by OM in case you had [Basic Authentication](/v1.13.x/deployment/security/basic-auth)
...
- [Implicit Flow](/v1.13.x/deployment/security/azure/implicit-flow) (Public)
- [Auth Code Flow](/v1.13.x/deployment/security/azure/auth-code-flow) (Confidential)
...
- **Web:**
  ...
  The [OIDC Authorization Code Flow](/v1.13.x/deployment/security/oidc) is used in this case, where the client secret is required to securely exchange the authorization code for tokens.
