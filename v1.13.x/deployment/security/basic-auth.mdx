...
import ConfigureIngestion from '/snippets/v1.13.x-SNAPSHOT/deployment/configure-ingestion.mdx'
...
configuration. To know how to enable it, you can follow the documentation of [Enable JWT Tokens](/v1.13.x-SNAPSHOT/deployment/security/enable-jwt-tokens).
