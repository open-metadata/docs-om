...
<CardGroup cols={2}>
<Card title="Use Nginx" href="/v1.13.x/deployment/security/enable-ssl/nginx" >
    Use Nginx to enable SSL. This is the simplest solution.
  </Card>
  <Card title="Use the OpenMetadata Server" href="/v1.13.x/deployment/security/enable-ssl/openmetadata-server" >
