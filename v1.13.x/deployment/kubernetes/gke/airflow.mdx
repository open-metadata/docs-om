...
Make sure to create CloudSQL and ElasticSearch credentials as Kubernetes Secrets mentioned [here](/v1.13.x/quick-start/local-kubernetes-deployment#2.-create-kubernetes-secrets-required-for-helm-charts).
...
Please validate:
- all the prerequisites mentioned in this [section](/v1.13.x/deployment/kubernetes/gke#prerequisites)
