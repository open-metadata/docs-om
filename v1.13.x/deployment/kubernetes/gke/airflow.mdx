...
Create CloudSQL and Elasticsearch credentials as Kubernetes Secrets, as described [here](/v1.13.x/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).
