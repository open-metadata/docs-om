...
The following values are used when `pipelineServiceClientConfig.type` is set to `k8s`. See the [Kubernetes Orchestrator](/v1.13.x/deployment/ingestion/kubernetes) guide for full documentation.
