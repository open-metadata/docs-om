...
<Info>
If you prefer to use Apache Airflow as the orchestrator for your EKS deployment, see the [Airflow on EKS](/v1.13.x/deployment/kubernetes/eks/airflow) guide.
</Info>
