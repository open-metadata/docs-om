...
Create database and search engine credentials as Kubernetes Secrets, as described [here](/v1.13.x/quick-start/local-kubernetes-deployment#2-create-kubernetes-secrets-required-for-helm-charts).

Also, disable MySQL and Elasticsearch from OpenMetadata Dependencies Helm Charts as described in the [FAQ](/v1.13.x/deployment/kubernetes/on-prem/airflow#how-to-disable-mysql-and-elasticsearch-from-openmetadata-dependencies-helm-charts-).
