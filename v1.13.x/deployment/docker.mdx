...
```bash
wget https://github.com/open-metadata/OpenMetadata/releases/download/1.13.4-release/docker-compose-openmetadata.yml
```
...
[Docker Advanced Configuration & Troubleshooting](/v1.13.x/deployment/docker/advanced).
