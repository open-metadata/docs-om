...
<CardGroup cols={2}>
  <Card title="Airflow Orchestrator" href="/v1.13.x/deployment/ingestion/openmetadata" icon="wind">
    Deploy, configure and manage the ingestion workflows using Apache Airflow as the orchestrator.
  </Card>
  <Card title="Kubernetes Orchestrator" href="/v1.13.x/deployment/ingestion/kubernetes" icon="cube">
...
<CardGroup cols={1}>
<Card title="External Ingestion" href="/v1.13.x/deployment/ingestion/external" >
