...
You can find more details about Docker deployment [here](/v1.13.x-SNAPSHOT/deployment/docker)
...
<Card title="Troubleshooting" href="/v1.13.x-SNAPSHOT/deployment/upgrade/docker-troubleshooting">
