...
[Kubernetes Deployment](/v1.13.x/deployment/kubernetes) guide.
...
You can learn more about how the migration process works [here](/v1.13.x/deployment/upgrade/how-does-it-work).
...
[Kubernetes Upgrade Troubleshooting](/v1.13.x/deployment/upgrade/kubernetes-troubleshooting).
