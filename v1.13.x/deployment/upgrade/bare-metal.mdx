...
[Bare Metal deployment](/v1.13.x/deployment/bare-metal) guide.

<Info>
Ready to upgrade? Continue to the [Upgrade Steps](/v1.13.x/deployment/upgrade/bare-metal/steps) for the step-by-step upgrade process and post-upgrade tasks.
</Info>
