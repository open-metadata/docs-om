...
import ReleaseNotes from '/snippets/releases/1.13.6.mdx';
import ReleaseNotes19 from '/snippets/releases/1.13.5.mdx';
...
<CardGroup>
  <Card
    ...
    Learn how to upgrade your OpenMetadata instance to 1.13.6!
  </Card>
</CardGroup>
