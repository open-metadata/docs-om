...
- OpenMetadata [Personal Access Token](/v1.13.x/how-to-guides/mcp#adding-a-personal-access-token-to-your-mcp-client)
...
- [OpenMetadata MCP Documentation](/v1.13.x/how-to-guides/mcp)
- [OAuth 2.0 Authentication](/v1.13.x/how-to-guides/mcp/oauth)
- [MCP Tools Reference](/v1.13.x/how-to-guides/mcp/reference)
