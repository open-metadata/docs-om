...
Follow the [Personal Access Token guide](/v1.13.x/how-to-guides/mcp#adding-a-personal-access-token-to-your-mcp-client) to generate your token.
...
6. **Token expired (PAT method)**: [Generate a new PAT](/v1.13.x/how-to-guides/guide-for-data-users/personal-access-token) and update your configuration
