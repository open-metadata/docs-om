...
Navigate to the Insights page. You should see your [Data Insights Reports](/v1.13.x-SNAPSHOT/how-to-guides/data-insights/report). Note that if you have just deployed OpenMetadata, App Analytics data might not be present. App Analytics data is fetched from the previous day (UTC).
