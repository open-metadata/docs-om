...
- **New to templates?** → Start with [Create and Manage Templates](/v1.13.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/create-and-manage-templates)
- **Want to write templates?** → Learn [Handlebars Templating Guide](/v1.13.x/how-to-guides/data-quality-observability/alerts-notifications/notification-templates/handlebars-templating-guide)
