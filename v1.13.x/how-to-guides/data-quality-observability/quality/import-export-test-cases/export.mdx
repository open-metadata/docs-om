...
5. Complete steps 5 to 6 from [Bulk Export Test Cases for a Table](#bulk-export-test-cases-for-a-table).
...
3. Complete steps 5 to 6 from [Bulk Export Test Cases for a Table](#bulk-export-test-cases-for-a-table).
