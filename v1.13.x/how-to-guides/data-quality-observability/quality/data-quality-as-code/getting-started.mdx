...
```bash
# For PostgreSQL
pip install "openmetadata-ingestion[postgres]~=1.13.0"

# For MySQL
pip install "openmetadata-ingestion[mysql]~=1.13.0"

# For BigQuery
pip install "openmetadata-ingestion[bigquery]~=1.13.0"

# For multiple databases
pip install "openmetadata-ingestion[postgres,mysql,bigquery]~=1.13.0"
```
...
```bash
pip install "openmetadata-ingestion[pandas]~=1.13.0"
```
...
pip install "openmetadata-ingestion[pandas,postgres]~=1.13.0"

# For comprehensive ETL support
pip install "openmetadata-ingestion[pandas,postgres,pyarrow]~=1.13.0"
```
...
```bash
pip install --upgrade "openmetadata-ingestion~=1.13.0"
```
