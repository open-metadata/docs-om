...
<Info>
If your organization uses an external secrets manager (AWS, Azure, GCP), see [Using External Secrets Managers](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/getting-started#using-external-secrets-managers) before using the TestRunner API.
</Info>
