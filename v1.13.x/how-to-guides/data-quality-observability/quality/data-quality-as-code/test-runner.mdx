...
<Note>
If your organization uses an external secrets manager for credential storage, TestRunner needs it configured before it can decrypt connection credentials. See [Using External Secrets Managers](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/getting-started#using-external-secrets-managers) before using the TestRunner API.
</Note>
...
<Info>
If your organization uses an external secrets manager (AWS, Azure, GCP), see [Using External Secrets Managers](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/getting-started#using-external-secrets-managers) in the Getting Started guide before using the TestRunner API.
</Info>

## Next Steps

- Learn about [DataFrame Validation](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/dataframe-validation) for validating transformations
...
- Explore [Advanced Usage](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/advanced-usage) including YAML workflows
