...
<Note>
⚠️ If you're using OpenMetadata Cloud to run OpenMetadata, please refer to [External Secrets Managers](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner/external-secrets) before using the TestRunner API.
</Note>
...
<Info>
If your organization uses an external secrets manager (AWS, Azure, GCP), see [External Secrets Managers](/v1.13.x/how-to-guides/data-quality-observability/quality/data-quality-as-code/test-runner/external-secrets) before using the TestRunner API.
</Info>
