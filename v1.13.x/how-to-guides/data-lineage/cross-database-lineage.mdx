...
Set **Cross Database Service Names** and other lineage options when adding a new Lineage Agent. For the full list of fields and how to set them, see [Lineage Options](/v1.13.x/how-to-guides/data-lineage/workflow#lineage-options).
