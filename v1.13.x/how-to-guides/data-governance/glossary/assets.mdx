...
By default, a table can be associated with more than one glossary term. Admins can restrict this to a single term per table in [Data Asset Rules](/v1.13.x/how-to-guides/admin-guide/data-asset-rules) using the **Tables can only have a single Glossary Term** rule.
