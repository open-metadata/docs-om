...
Each term has a **life cycle status** (e.g., Draft, Approved). Glossary terms can be added manually. You can also [export or bulk import the glossary terms](/v1.13.x/how-to-guides/data-governance/glossary/import) using a CSV file.
...
<Card title="How to Setup a Glossary" href="/v1.13.x/how-to-guides/data-governance/glossary/setup" >
