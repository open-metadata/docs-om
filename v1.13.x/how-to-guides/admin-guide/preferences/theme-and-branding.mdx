...
Admins can customize the OpenMetadata interface to match their organization's branding. The setting lives in **Settings** > **Preferences** > **Theme**, and has two panels:
...
<img src="/public/images/how-to-guides/admin-guide/preferences/access-theme-1.13.png" alt="Theme highlighted under Preferences" />
...
<Note>
  Theme and Custom Logo are organization-wide settings and require Admin access.
</Note>
