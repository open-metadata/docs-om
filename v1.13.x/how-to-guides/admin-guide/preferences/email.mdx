...
3. Configure the following fields:
    ...
    | **Support URL** | Link included in emails for users to reach your support team. Default: `https://slack.open-metadata.org` | Gives recipients a way to get help without it dead-ending at your defaults |
