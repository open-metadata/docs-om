...
1. Click the **Profile** icon and navigate to **Settings** > **Preferences** > **Email**.

    <img src="/public/images/how-to-guides/admin-guide/preferences/access-email-1.13.png" alt="Email settings under Preferences" />
...
OpenMetadata URL is a separate, single-field setting stored alongside Email configuration, since it's used to build the links inside the emails OpenMetadata sends, for example the "view this asset" link in a task notification. If this points at the wrong address, every link in every notification email points at the wrong place, even though the emails themselves send successfully.

1. Click the **Profile** icon and navigate to **Settings** > **Preferences** > **OpenMetadata URL**.
