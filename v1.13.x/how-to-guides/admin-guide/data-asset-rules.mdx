...
- [Data Contracts](/v1.13.x/how-to-guides/data-contracts/spec#semantics) use a similarly-shaped mechanism scoped to a single asset instead of the whole platform.
- [Data Products](/v1.13.x/how-to-guides/data-marketplace/data-products#troubleshooting) and [Domains](/v1.13.x/how-to-guides/data-marketplace/domains) cover how the domain and Data Product rules apply in practice, including a known limitation with subdomains.
- [How to Assign or Change Data Ownership](/v1.13.x/how-to-guides/guide-for-data-users/data-ownership) covers the ownership rule.
- [How to Add Assets to Glossary Terms](/v1.13.x/how-to-guides/data-governance/glossary/assets) covers the Glossary Term rule.
