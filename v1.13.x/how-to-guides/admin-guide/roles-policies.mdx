...
Every object in OpenMetadata belongs to a resource category — from core data assets like Tables and Databases, to governance resources like Glossary Terms and Tags, to admin resources like Users, Roles, and Policies. For a reference overview of resource categories, the resources each includes, and risk levels, see [Resource scope and operations reference](/v1.11.x/how-to-guides/admin-guide/roles-policies/resource-scope).
...
For a curated reference of common operations and resource types, see [Resource scope and operations reference](/v1.11.x/how-to-guides/admin-guide/roles-policies/resource-scope).
